...
}, VI = { class: "flex flex-col items-center gap-4 bg-white p-2" }, KI = /* @__PURE__ */ ne("div", { class: "flex flex-col w-full gap-4" }, [
  /* @__PURE__ */ ne("a", {
