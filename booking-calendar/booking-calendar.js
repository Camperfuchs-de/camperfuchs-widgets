...
(e.charCodeAt(2) > 122 || e.charCodeAt(2) < 97), is = (e) => e.startsWith("onUpdate:"), Be = Object.assign, ls = (e, t) => {
  const r = e.indexOf(t);
  r > -1 && e.splice(r, 1);
}, Zf = Object.prototype.hasOwnProperty, me = (e, t) => Zf.call(e, t), se = Array.isArray, zr = (e) => Uo(e) === "[object Map]", uc = (e) => Uo(e) === "[object Set]", ue = (e) => typeof e == "function", $e = (e) => typeof e == "string", on = (e) => typeof e == "symbol", Ce = (e) => e !== null && typeof e == "object", fc = (e) => (Ce(e) || ue(e)) && ue(e.then) && ue(e.catch), dc = Object.prototype.toString, Uo = (e) => dc.call(e), Jf = (e) => Uo(e).slice(8, -1), vc = (e) => Uo(e) === "[object Object]", cs = (e) => $e(e) && e !== "NaN" && e[0] !== "-" && "" + parseInt(e, 10) === e, vo = /* @__PURE__ */ ss(
...
const Le = (e) => $e(e) ? e : e == null ? "" : se(e) || Ce(e) && (e.toString === dc || !ue(e.toString)) ? JSON.stringify(e, mc, 2) : String(e), mc = (e, t) => t && t.__v_isRef ? mc(e, t.value) : zr(t) ? {
...
function bc(e, t, r) {
  if (t.get(e) !== e._trackId) {
    ...
    n !== t ? (n && gc(n, e), e.deps[e._depsLength++] = t) : e._depsLength++;
  }
}
const Pa = [];
function wc(e, t, r) {
...
class xc extends Ac {
  ...
  set(t, r, n, o) {
    ...
    const s = se(t) && cs(r) ? Number(r) < t.length : me(t, r), i = Reflect.set(t, r, n, o);
...
const yd = /* @__PURE__ */ new xc(), bd = /* @__PURE__ */ new gd(), wd = /* @__PURE__ */ new xc(
  !0
...
function Xn(e, t, r = !1, n = !1) {
  ...
  const { has: s } = Wo(o), i = n ? vs : r ? ms : Nn;
  if (s.call(o, t))
    return i(e.get(t));
  if (s.call(o, a))
    return i(e.get(a));
...
function ro(e, t) {
  return function(n, o) {
    const a = this, s = a.__v_raw, i = pe(s), l = t ? vs : e ? ms : Nn;
    return !e && it(i, "iterate", Or), s.forEach((c, u) => n.call(o, l(c), l(u), a));
  };
}
function no(e, t, r) {
  return function(...n) {
    const o = this.__v_raw, a = pe(o), s = zr(a), i = e === "entries" || e === Symbol.iterator && s, l = e === "keys" && s, c = o[e](...n), u = r ? vs : t ? ms : Nn;
    return !t && it(
      a,
      "iterate",
      l ? $a : Or
...
const Nn = (e) => Ce(e) ? an(e) : e, ms = (e) => Ce(e) ? kc(e) : e;
class Sc {
  constructor(t, r, n, o) {
...
function Fc(e) {
  ...
  try {
    ...
    Pt = 0, Qe.length = 0, Lc(), Rn = !1, gs = null, (Qe.length || Vr.length) && Fc();
  }
}
function qd(e, t, ...r) {
  if (e.isUnmounted)
...
function va(e) {
  ...
  try {
    ...
    Pn.length = 0, zo(E, e, 1), D = le(yt);
  }
  let L = D;
  if (y && b !== !1) {
    const E = Object.keys(y), { shapeFlag: x } = L;
    E.length && x & 7 && (s && E.some(is) && (y = Jd(
      y,
      s
    )), L = Vt(L, y));
  }
  return r.dirs && (L = Vt(L), L.dirs = L.dirs ? L.dirs.concat(r.dirs) : r.dirs), r.transition && (L.transition = r.transition), D = L, xo(F), D;
}
const Zd = (e) => {
  let t;
  for (const r in e)
...
function _s(e, t, {
  ...
  const y = () => {
    if (!(!L.active || !L.dirty))
      if (t) {
        const x = L.run();
        (n || f || (d ? x.some((V, I) => ur(V, D[I])) : ur(x, D))) && (h && h(), mt(t, c, 3, [
          x,
  ...
  y.allowRecurse = !!t;
  let F;
  o === "sync" ? F = y : o === "post" ? F = () => ot(y, c && c.suspense) : (y.pre = !0, c && (y.id = c.uid), F = () => ys(y));
  const L = new us(u, ut, F), E = () => {
    L.stop(), c && c.scope && ls(c.scope.effects, L);
  };
  return t ? r ? y() : D = L.run() : o === "post" ? ot(
    L.run.bind(L),
    c && c.suspense
  ) : L.run(), b && b.push(E), E;
}
  ...
  setup(e, { slots: t }) {
    ...
    return () => {
      ...
      if (d && d.type !== yt && (!Ar(c, d) || h)) {
        ...
        l === "in-out" && c.type !== yt && (b.delayLeave = (D, y, F) => {
          const L = Vc(
            n,
            d
          );
          L[String(d.key)] = d, D[or] = () => {
            y(), D[or] = void 0, delete u.delayedLeave;
          }, u.delayedLeave = F;
        });
      }
      return s;
...
function Ra(e, t, r, n) {
  const {
    ...
    onAfterAppear: y,
    onAppearCancelled: F
  } = t, L = String(e.key), E = Vc(r, e), x = (C, B) => {
    C && mt(
      C,
      n,
      9,
    ...
    const j = B[1];
    x(C, B), se(C) ? C.every((K) => K.length <= 1) && j() : C.length <= 1 && j();
  }, I = {
    mode: a,
    persisted: s,
    beforeEnter(C) {
      ...
      const j = E[L];
      j && Ar(e, j) && j.el[or] && j.el[or](), x(B, [C]);
    },
    enter(C) {
      let B = l, j = c, K = u;
      if (!r.isMounted)
      ...
      let _ = !1;
      const U = C[ao] = (oe) => {
        _ || (_ = !0, oe ? x(K, [C]) : x(j, [C]), I.delayedLeave && I.delayedLeave(), C[ao] = void 0);
      };
      B ? V(B, [C, U]) : U();
    },
    leave(C, B) {
      ...
      let K = !1;
      const _ = C[or] = (U) => {
        K || (K = !0, B(), U ? x(g, [C]) : x(h, [C]), C[or] = void 0, E[j] === e && delete E[j]);
      };
      E[j] = e, d ? V(d, [C, _]) : _();
    },
    clone(C) {
...
), pv = Zt("bm"), Pr = Zt("m"), hv = Zt("bu"), mv = Zt("u"), qc = Zt("bum"), Gn = Zt("um"), gv = Zt("sp"), yv = Zt(
  "rtg"
), bv = Zt(
  "rtc"
);
...
const Fa = (e) => e ? fu(e) ? Xo(e) || e.proxy : Fa(e.parent) : null, Tn = (
...
), ha = (e, t) => e !== ke && !e.__isScriptSetup && me(e, t), Dv = {
  get({ _: e }, t) {
  ...
  has({
    ...
    let i;
    return !!r[s] || e !== ke && me(e, s) || ha(t, s) || (i = a[0]) && me(i, s) || me(n, s) || me(Tn, s) || me(o.config.globalProperties, s);
  },
...
function Av(e) {
  ...
  if (Ba = !0, a)
    for (const ee in a) {
      const ie = a[ee], he = ue(ie) ? ie.bind(r, r) : ue(ie.get) ? ie.get.bind(r, r) : ut, Y = !ue(ie) && ue(ie.set) ? ie.set.bind(r) : ut, de = A({
        get: he,
        set: Y
      });
  ...
  if (re(pv, f), re(Pr, d), re(hv, h), re(mv, g), re(fv, b), re(dv, D), re(wv, C), re(bv, V), re(yv, I), re(qc, F), re(Gn, E), re(gv, B), se(j))
    if (j.length) {
      ...
      e.exposed || (e.exposed = {});
  x && e.render === ut && (e.render = x), K != null && (e.inheritAttrs = K), _ && (e.components = _), U && (e.directives = U);
}
    ...
    if (d || h) {
      const g = () => {
        if (e.f) {
          ...
          o ? se(b) && ls(b, a) : se(b) ? b.includes(a) || b.push(a) : d ? (u[l] = [a], me(f, l) && (f[l] = u[l])) : (l.value = [a], e.k && (u[e.k] = l.value));
        } else
...
function Nv(e, t) {
  ...
  const {
  ...
  } = e, b = (v, m, w, O = null, M = null, N = null, H = void 0, $ = null, R = !!m.dynamicChildren) => {
    if (v === m)
      return;
    v && !Ar(v, m) && (O = Me(v), q(v, M, N, !0), v = null), m.patchFlag === -2 && (R = !1, m.dynamicChildren = null);
    ...
    m.type === "svg" ? H = "svg" : m.type === "math" && (H = "mathml"), v == null ? V(
      m,
      w,
      O,
      M,
    ...
    let R, S;
    const { props: W, shapeFlag: X, transition: Z, dirs: ae } = v;
    if (R = v.el = s(
      v.type,
      N,
      W && W.is,
      W
    ), X & 8 ? u(R, v.children) : X & 16 && C(
      v.children,
      R,
      null,
      O,
      ...
      H,
      $
    ), ae && gr(v, null, O, "created"), I(R, v, v.scopeId, H, O), W) {
      for (const ve in W)
        ve !== "value" && !vo(ve) && a(
          R,
          ve,
    ...
    ae && gr(v, null, O, "beforeMount");
    const ce = Rv(M, Z);
    ce && Z.beforeEnter(R), n(R, m, w), ((S = W && W.onVnodeMounted) || ce || ae) && ot(() => {
      S && Et(S, O, v), ce && Z.enter(R), ae && gr(v, null, O, "mounted");
    }, M);
  }, I = (v, m, w, O, M) => {
    if (w && h(v, w), O)
    ...
    const $ = m.el = v.el;
    let { patchFlag: R, dynamicChildren: S, dirs: W } = m;
    R |= v.patchFlag & 16;
    const X = v.props || ke, Z = m.props || ke;
    let ae;
    if (w && yr(w, !1), (ae = Z.onVnodeBeforeUpdate) && Et(ae, w, m, v), W && gr(m, v, w, "beforeUpdate"), w && yr(w, !0), S ? j(
      v.dynamicChildren,
      S,
      $,
      w,
      ...
      else if (R & 2 && X.class !== Z.class && a($, "class", null, Z.class, M), R & 4 && a($, "style", X.style, Z.style, M), R & 8) {
      ...
      R & 1 && v.children !== m.children && u($, m.children);
    } else
      !H && S == null && K(
        $,
        m,
    ...
    ((ae = Z.onVnodeUpdated) || W) && ot(() => {
      ae && Et(ae, w, m, v), W && gr(m, v, w, "updated");
    }, O);
  }, j = (v, m, w, O, M, N, H) => {
    for (let $ = 0; $ < m.length; $++) {
      const R = v[$], S = m[$], W = (
    ...
    if (w !== O) {
      ...
      "value" in O && a(v, "value", w.value, O.value, H);
    }
  }, _ = (v, m, w, O, M, N, H, $, R) => {
    const S = m.el = v ? v.el : i(""), W = m.anchor = v ? v.anchor : i("");
    let { patchFlag: X, dynamicChildren: Z, slotScopeIds: ae } = m;
    ...
    if (Xd(v, m, w))
      if (O.asyncDep && !O.asyncResolved) {
        ...
        O.next = m, Vd(O.update), O.effect.dirty = !0, O.update();
    else
      m.el = v.el, O.vnode = m;
  }, re = (v, m, w, O, M, N, H) => {
    const $ = () => {
      if (v.isMounted) {
        let { next: W, bu: X, u: Z, parent: ae, vnode: ce } = v;
        {
          const kt = su(v);
          if (kt) {
            W && (W.el = ce.el, ee(v, W, H)), kt.asyncDep.then(() => {
              v.isUnmounted || $();
            });
            return;
          }
        ...
        let ve = W, ye;
        yr(v, !1), W ? (W.el = ce.el, ee(v, W, H)) : W = ce, X && fa(X), (ye = W.props && W.props.onVnodeBeforeUpdate) && Et(ye, ae, W, ce), yr(v, !0);
        ...
        v.subTree = Te, b(
          ...
          M,
          N
        ), W.el = Te.el, ve === null && ev(v, Te.el), Z && ot(Z, M), (ye = W.props && W.props.onVnodeUpdated) && ot(
          () => Et(ye, ae, W, ce),
          M
        );
      } else {
        let W;
        const { el: X, props: Z } = m, { bm: ae, m: ce, parent: ve } = v, ye = Sn(m);
        if (yr(v, !1), ae && fa(ae), !ye && (W = Z && Z.onVnodeBeforeMount) && Et(W, ve, m), yr(v, !0), X && Ze) {
          const Te = () => {
            v.subTree = va(v), Ze(
              X,
              v.subTree,
        ...
        (m.shapeFlag & 256 || ve && Sn(ve.vnode) && ve.vnode.shapeFlag & 256) && v.a && ot(v.a, M), v.isMounted = !0, m = w = O = null;
      }
    }, R = v.effect = new us(
      $,
      ut,
    ...
    v.vnode = m, v.next = null, Sv(v, m.props, O, w), $v(v, m.children, w), dr(), di(v), vr();
  }, ie = (v, m, w, O, M, N, H, $, R = !1) => {
    const S = v && v.children, W = v ? v.shapeFlag : 0, X = m.children, { patchFlag: Z, shapeFlag: ae } = m;
    if (Z > 0) {
      if (Z & 128) {
        Y(
          S,
    ...
    ae & 8 ? (W & 16 && De(S, M, N), X !== S && u(w, X)) : W & 16 ? ae & 16 ? Y(
      S,
      X,
      w,
      O,
    ...
    for (; S <= X && S <= Z; ) {
      const ae = v[S], ce = m[S] = R ? ar(m[S]) : Tt(m[S]);
      if (Ar(ae, ce))
        b(
          ae,
          ce,
    ...
    for (; S <= X && S <= Z; ) {
      const ae = v[X], ce = m[Z] = R ? ar(m[Z]) : Tt(m[Z]);
      if (Ar(ae, ce))
        b(
          ae,
          ce,
    ...
    if (S > X) {
      if (S <= Z) {
        const ae = Z + 1, ce = ae < W ? m[ae].el : O;
        for (; S <= Z; )
          b(
            null,
            m[S] = R ? ar(m[S]) : Tt(m[S]),
      ...
      for (S = ae; S <= X; S++) {
        ...
        Je === void 0 ? q(He, M, N, !0) : (It[Je - ce] = S + 1, Je >= mr ? mr = Je : kt = !0, b(
          He,
          m[Je],
          w,
          null,
      ...
      for (ye = Lr.length - 1, S = ze - 1; S >= 0; S--) {
        const He = ce + S, Je = m[He], P = He + 1 < W ? m[He + 1].el : O;
        It[S] === 0 ? b(
          null,
          Je,
          w,
    ...
    const { el: N, type: H, transition: $, children: R, shapeFlag: S } = v;
    if (S & 6) {
    ...
    if (O !== 2 && S & 1 && $)
      if (O === 0)
        $.beforeEnter(N), n(N, m, w), ot(() => $.enter(N), M);
      else {
        const { leave: X, delayLeave: Z, afterLeave: ae } = $, ce = () => n(N, m, w), ve = () => {
          X(N, () => {
            ce(), ae && ae();
          });
        };
    ...
    const ae = W & 1 && Z, ce = !Sn(v);
    let ve;
    if (ce && (ve = H && H.onVnodeBeforeUnmount) && Et(ve, m, v), W & 6)
      Se(v.component, w, O);
    else {
      if (W & 128) {
      ...
      ae && gr(v, null, m, "beforeUnmount"), W & 64 ? v.type.remove(
        v,
        m,
        w,
        M,
      ...
      (N !== we || X > 0 && X & 64) ? De(
        ...
        !1,
        !0
      ) : (N === we && X & 384 || !M && W & 16) && De(R, m, w), O && Ie(v);
    }
    (ce && (ve = H && H.onVnodeUnmounted) || ae) && ot(() => {
      ve && Et(ve, m, v), ae && gr(v, null, m, "unmounted");
    }, w);
  }, Ie = (v) => {
    ...
    if (v.shapeFlag & 1 && M && !M.persisted) {
      const { leave: H, delayLeave: $ } = M, R = () => H(w, N);
      $ ? $(v.el, N, R) : R();
    } else
      N();
  }, ge = (v, m) => {
    ...
    const { bum: O, scope: M, update: N, subTree: H, um: $ } = v;
    O && fa(O), M.stop(), N && (N.active = !1, q(H, v, m, w)), $ && ot($, m), ot(() => {
      v.isUnmounted = !0;
    }, m), m && m.pendingBranch && !m.isUnmounted && v.asyncDep && !v.asyncResolved && v.suspenseId === m.pendingId && (m.deps--, m.deps === 0 && m.resolve());
  }, De = (v, m, w, O = !1, M = !1, N = 0) => {
    for (let H = N; H < v.length; H++)
      q(v[H], m, w, O, M);
...
const Fv = (e) => e.__isTeleport, we = Symbol.for("v-fgt"), Qo = Symbol.for("v-txt"), yt = Symbol.for("v-cmt"), ga = Symbol.for("v-stc"), Pn = [];
let xt = null;
function G(e = !1) {
  Pn.push(xt = e ? null : []);
}
...
const Uv = (...e) => cu(
  ...e
), qo = "__vInternal", lu = ({ key: e }) => e ?? null, mo = ({
  ref: e,
  ref_key: t,
  ref_for: r
...
function Vt(e, t, r = !1) {
  ...
  return {
    ...
    ref: t && t.ref ? (
      ...
      r && o ? se(o) ? o.concat(mo(t)) : [o, mo(t)] : mo(t)
    ) : o,
    scopeId: e.scopeId,
...
function op(e) {
  ...
  const {
    ...
    onBeforeAppear: V = y,
    onAppear: I = F,
    onAppearCancelled: C = L
  } = t, B = (_, U, oe) => {
    wr(_, U ? u : i), wr(_, U ? c : s), oe && oe();
  }, j = (_, U) => {
    _._isLeaving = !1, wr(_, f), wr(_, h), wr(_, d), U && U();
  }, K = (_) => (U, oe) => {
    const Q = _ ? I : F, re = () => B(U, _, oe);
    br(Q, [U, re]), Ii(() => {
      wr(U, _ ? l : a), rr(U, _ ? u : i), ki(Q) || Ei(U, n, b, re);
    });
  };
  return Be(t, {
    onBeforeEnter(_) {
    ...
    onLeave(_, U) {
      ...
      const oe = () => j(_, U);
      rr(_, f), lp(), rr(_, d), Ii(() => {
        _._isLeaving && (wr(_, f), rr(_, h), ki(E) || Ei(_, n, D, oe));
      }), br(E, [_, oe]);
    },
    onEnterCancelled(_) {
      B(_, !1), br(L, [_]);
...
function ip(e, t) {
  const r = window.getComputedStyle(e), n = (g) => (r[g] || "").split(", "), o = n(`${tr}Delay`), a = n(`${tr}Duration`), s = Si(o, a), i = n(`${yn}Delay`), l = n(`${yn}Duration`), c = Si(i, l);
  let u = null, f = 0, d = 0;
...
e.charCodeAt(2) > 96 && e.charCodeAt(2) < 123, Ap = (e, t, r, n, o, a, s, i, l) => {
  const c = o === "svg";
  t === "class" ? cp(e, n, c) : t === "style" ? fp(e, r, n) : Bo(t) ? is(t) || gp(e, t, r, n, s) : (t[0] === "." ? (t = t.slice(1), !0) : t[0] === "^" ? (t = t.slice(1), !1) : xp(e, t, n, c)) ? pp(
    e,
    t,
    n,
    a,
...
var at = "top", _t = "bottom", Dt = "right", st = "left", ks = "auto", Kn = [at, _t, Dt, st], Jr = "start", Un = "end", Pp = "clippingParents", mu = "viewport", wn = "popper", $p = "reference", Hi = /* @__PURE__ */ Kn.reduce(function(e, t) {
  return e.concat([t + "-" + Jr, t + "-" + Un]);
}, []), gu = /* @__PURE__ */ [].concat(Kn, [ks]).reduce(function(e, t) {
...
function Jp(e) {
  ...
  if (!(!a || !s)) {
    var f = Zp(o.padding, r), d = Es(a), h = l === "y" ? at : st, g = l === "y" ? _t : Dt, b = r.rects.reference[u] + r.rects.reference[l] - s[l] - r.rects.popper[u], D = s[l] - r.rects.reference[l], y = Qn(a), F = y ? l === "y" ? y.clientHeight || 0 : y.clientWidth || 0 : 0, L = b / 2 - D / 2, E = f[h], x = F - d[u] - f[g], V = F / 2 - d[u] / 2 + L, I = $n(E, V, x), C = l;
...
function Wi(e) {
  var t, r = e.popper, n = e.popperRect, o = e.placement, a = e.variation, s = e.offsets, i = e.position, l = e.gpuAcceleration, c = e.adaptive, u = e.roundOffsets, f = e.isFixed, d = s.x, h = d === void 0 ? 0 : d, g = s.y, b = g === void 0 ? 0 : g, D = typeof u == "function" ? u({
    x: h,
    y: b
  }) : {
    x: h,
  ...
  h = D.x, b = D.y;
  var y = s.hasOwnProperty("x"), F = s.hasOwnProperty("y"), L = st, E = at, x = window;
  if (c) {
    ...
    if (V === dt(r) && (V = pr(r), Kt(V).position !== "static" && i === "absolute" && (I = "scrollHeight", C = "scrollWidth")), V = V, o === at || (o === st || o === Dt) && a === Un) {
      E = _t;
      var B = f && V === x && x.visualViewport ? x.visualViewport.height : (
        // $FlowFixMe[prop-missing]
        V[I]
      );
      b -= B - n.height, b *= l ? 1 : -1;
    }
    if (o === st || (o === at || o === _t) && a === Un) {
      L = Dt;
      var j = f && V === x && x.visualViewport ? x.visualViewport.width : (
        // $FlowFixMe[prop-missing]
        V[C]
      );
      h -= j - n.width, h *= l ? 1 : -1;
  ...
  if (h = _.x, b = _.y, l) {
    var U;
    return Object.assign({}, K, (U = {}, U[E] = F ? "0" : "", U[L] = y ? "0" : "", U.transform = (x.devicePixelRatio || 1) <= 1 ? "translate(" + h + "px, " + b + "px)" : "translate3d(" + h + "px, " + b + "px, 0)", U));
  }
  return Object.assign({}, K, (t = {}, t[E] = F ? b + "px" : "", t[L] = y ? h + "px" : "", t.transform = "", t));
}
function nh(e) {
...
function Gi(e, t, r) {
  return t === mu ? Va(ch(e, r)) : Sr(t) ? fh(t, r) : Va(uh(pr(e)));
}
function dh(e) {
...
function Hn(e, t) {
  t === void 0 && (t = {});
  var r = t, n = r.placement, o = n === void 0 ? e.placement : n, a = r.strategy, s = a === void 0 ? e.strategy : a, i = r.boundary, l = i === void 0 ? Pp : i, c = r.rootBoundary, u = c === void 0 ? mu : c, f = r.elementContext, d = f === void 0 ? wn : f, h = r.altBoundary, g = h === void 0 ? !1 : h, b = r.padding, D = b === void 0 ? 0 : b, y = _u(typeof D != "number" ? D : Du(D, Kn)), F = d === wn ? $p : wn, L = e.rects.popper, E = e.elements[g ? F : d], x = vh(Sr(E) ? E : E.contextElement || pr(e.elements.popper), l, u, s), V = en(e.elements.reference), I = xu({
    reference: V,
    element: L,
    strategy: "absolute",
    placement: o
  }), C = Va(Object.assign({}, L, I)), B = d === wn ? C : V, j = {
    top: x.top - B.top + y.top,
    bottom: B.bottom - x.bottom + y.bottom,
    left: x.left - B.left + y.left,
    right: B.right - x.right + y.right
  }, K = e.modifiersData.offset;
  if (d === wn && K) {
    var _ = K[o];
    Object.keys(j).forEach(function(U) {
      var oe = [Dt, _t].indexOf(U) >= 0 ? 1 : -1, Q = [at, _t].indexOf(U) >= 0 ? "y" : "x";
      j[U] += _[Q] * oe;
    });
  }
  return j;
...
function ph(e, t) {
  t === void 0 && (t = {});
  var r = t, n = r.placement, o = r.boundary, a = r.rootBoundary, s = r.padding, i = r.flipVariations, l = r.allowedAutoPlacements, c = l === void 0 ? gu : l, u = tn(n), f = u ? i ? Hi : Hi.filter(function(g) {
    return tn(g) === u;
...
function mh(e) {
  ...
  if (!t.modifiersData[n]._skip) {
    for (var o = r.mainAxis, a = o === void 0 ? !0 : o, s = r.altAxis, i = s === void 0 ? !0 : s, l = r.fallbackPlacements, c = r.padding, u = r.boundary, f = r.rootBoundary, d = r.altBoundary, h = r.flipVariations, g = h === void 0 ? !0 : h, b = r.allowedAutoPlacements, D = t.options.placement, y = Nt(D), F = y === D, L = l || (F || !g ? [go(D)] : hh(D)), E = [D].concat(L).reduce(function(ge, Se) {
      return ge.concat(Nt(Se) === ks ? ph(t, {
        placement: Se,
        boundary: u,
        rootBoundary: f,
        padding: c,
    ...
    }, []), x = t.rects.reference, V = t.rects.popper, I = /* @__PURE__ */ new Map(), C = !0, B = E[0], j = 0; j < E.length; j++) {
      var K = E[j], _ = Nt(K), U = tn(K) === Jr, oe = [at, _t].indexOf(_) >= 0, Q = oe ? "width" : "height", re = Hn(t, {
        placement: K,
        boundary: u,
        rootBoundary: f,
        altBoundary: d,
        padding: c
      }), ee = oe ? U ? Dt : st : U ? _t : at;
      x[Q] > V[Q] && (ee = go(ee));
      var ie = go(ee), he = [];
      if (a && he.push(re[_] <= 0), i && he.push(re[ee] <= 0, re[ie] <= 0), he.every(function(ge) {
        return ge;
      })) {
        B = K, C = !1;
        break;
    ...
    if (C)
      for (var Y = g ? 3 : 1, de = function(Se) {
...
function _h(e) {
  var t = e.state, r = e.options, n = e.name, o = r.offset, a = o === void 0 ? [0, 0] : o, s = gu.reduce(function(u, f) {
...
function Mh(e) {
  var t = e.state, r = e.options, n = e.name, o = r.mainAxis, a = o === void 0 ? !0 : o, s = r.altAxis, i = s === void 0 ? !1 : s, l = r.boundary, c = r.rootBoundary, u = r.altBoundary, f = r.padding, d = r.tether, h = d === void 0 ? !0 : d, g = r.tetherOffset, b = g === void 0 ? 0 : g, D = Hn(t, {
    boundary: l,
    rootBoundary: c,
    padding: f,
    altBoundary: u
  }), y = Nt(t.placement), F = tn(t.placement), L = !F, E = Ss(y), x = Ch(E), V = t.modifiersData.popperOffsets, I = t.rects.reference, C = t.rects.popper, B = typeof b == "function" ? b(Object.assign({}, t.rects, {
    placement: t.placement
  })) : b, j = typeof B == "number" ? {
    mainAxis: B,
    altAxis: B
    ...
    mainAxis: 0,
    altAxis: 0
  }, B), K = t.modifiersData.offset ? t.modifiersData.offset[t.placement] : null, _ = {
    x: 0,
    y: 0
  };
  if (V) {
    if (a) {
      var U, oe = E === "y" ? at : st, Q = E === "y" ? _t : Dt, re = E === "y" ? "height" : "width", ee = V[E], ie = ee + D[oe], he = ee - D[Q], Y = h ? -C[re] / 2 : 0, de = F === Jr ? I[re] : C[re], q = F === Jr ? -C[re] : -I[re], Ie = t.elements.arrow, ge = h && Ie ? Es(Ie) : {
        width: 0,
        height: 0
      }, Se = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : wu(), De = Se[oe], Me = Se[Q], Ne = $n(0, I[re], ge[re]), Re = L ? I[re] / 2 - Y - Ne - De - j.mainAxis : de - Ne - De - j.mainAxis, lt = L ? -I[re] / 2 + Y + Ne + Me + j.mainAxis : q + Ne + Me + j.mainAxis, Ze = t.elements.arrow && Qn(t.elements.arrow), v = Ze ? E === "y" ? Ze.clientTop || 0 : Ze.clientLeft || 0 : 0, m = (U = K == null ? void 0 : K[E]) != null ? U : 0, w = ee + Re - m - v, O = ee + lt - m, M = $n(h ? Io(ie, w) : ie, ee, h ? Er(he, O) : he);
      V[E] = M, _[E] = M - ee;
    }
    if (i) {
      var N, H = E === "x" ? at : st, $ = E === "x" ? _t : Dt, R = V[x], S = x === "y" ? "height" : "width", W = R + D[H], X = R - D[$], Z = [at, st].indexOf(y) !== -1, ae = (N = K == null ? void 0 : K[x]) != null ? N : 0, ce = Z ? W : R - I[S] - C[S] - ae + j.altAxis, ve = Z ? R + I[S] + C[S] - ae - j.altAxis : X, ye = h && Z ? qp(ce, R, ve) : $n(h ? ce : W, R, h ? ve : X);
      V[x] = ye, _[x] = ye - R;
    }
    t.modifiersData[n] = _;
  }
  ...
  return function(i, l, c) {
    ...
    var u = {
      ...
      setOptions: function(y) {
        var F = typeof y == "function" ? y(u.options) : y;
        b(), u.options = Object.assign({}, a, u.options, F), u.scrollParents = {
          reference: Sr(i) ? Yn(i) : i.contextElement ? Yn(i.contextElement) : [],
          popper: Yn(l)
        };
        var L = Ph(Yh([].concat(n, u.options.modifiers)));
        return u.orderedModifiers = L.filter(function(E) {
          return E.enabled;
        }), g(), h.update();
      },
      ...
      forceUpdate: function() {
        if (!d) {
          var y = u.elements, F = y.reference, L = y.popper;
          if (qi(F, L)) {
            u.rects = {
              reference: Sh(F, Qn(L), u.options.strategy === "fixed"),
              popper: Es(L)
            ...
            for (var E = 0; E < u.orderedModifiers.length; E++) {
              ...
              var x = u.orderedModifiers[E], V = x.fn, I = x.options, C = I === void 0 ? {} : I, B = x.name;
    ...
    function g() {
      u.orderedModifiers.forEach(function(D) {
        var y = D.name, F = D.options, L = F === void 0 ? {} : F, E = D.effect;
...
var Rh = [sh, xh, oh, Vp, Dh, gh, Oh, eh, bh], Lh = /* @__PURE__ */ Nh({
  defaultModifiers: Rh
...
var tm = em, rm = Object.prototype, nm = rm.toString;
function om(e) {
  return nm.call(e);
}
var am = om, Ji = ra, sm = tm, im = am, lm = "[object Null]", cm = "[object Undefined]", Xi = Ji ? Ji.toStringTag : void 0;
function um(e) {
  return e == null ? e === void 0 ? cm : lm : Xi && Xi in Object(e) ? sm(e) : im(e);
}
var Ft = um;
function fm(e) {
  return e != null && typeof e == "object";
}
var Ot = fm, dm = Ft, vm = Ot, pm = "[object Symbol]";
function hm(e) {
  return typeof e == "symbol" || vm(e) && dm(e) == pm;
}
var Ys = hm, mm = Mt, gm = Ys, ym = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, bm = /^\w*$/;
function wm(e, t) {
  if (mm(e))
    return !1;
  var r = typeof e;
  return r == "number" || r == "symbol" || r == "boolean" || e == null || gm(e) ? !0 : bm.test(e) || !ym.test(e) || t != null && e in Object(t);
}
var Ns = wm;
function _m(e) {
  var t = typeof e;
...
var Jt = _m, Dm = Ft, Am = Jt, xm = "[object AsyncFunction]", Cm = "[object Function]", Mm = "[object GeneratorFunction]", Om = "[object Proxy]";
function km(e) {
  if (!Am(e))
    return !1;
  var t = Dm(e);
  return t == Cm || t == Mm || t == xm || t == Om;
}
var Yr = km, Im = Lt, Em = Im["__core-js_shared__"], Sm = Em, Da = Sm, el = function() {
...
var Pm = Tm, $m = Function.prototype, Ym = $m.toString;
function Nm(e) {
  if (e != null) {
    try {
      return Ym.call(e);
...
var ku = Nm, Rm = Yr, Lm = Pm, Fm = Jt, Bm = ku, Um = /[\\^$.*+?()[\]{}|]/g, Hm = /^\[object .+?Constructor\]$/, jm = Function.prototype, Wm = Object.prototype, zm = jm.toString, Gm = Wm.hasOwnProperty, Vm = RegExp(
  "^" + zm.call(Gm).replace(Um, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
);
function Km(e) {
  if (!Fm(e) || Lm(e))
    return !1;
...
var Zm = qm, Jm = Qm, Xm = Zm;
function eg(e, t) {
  var r = Xm(e, t);
  return Jm(r) ? r : void 0;
}
var Nr = eg, tg = Nr, rg = tg(Object, "create"), na = rg, tl = na;
function ng() {
...
var sg = ag, ig = na, lg = "__lodash_hash_undefined__", cg = Object.prototype, ug = cg.hasOwnProperty;
function fg(e) {
  var t = this.__data__;
  if (ig) {
    var r = t[e];
...
var dg = fg, vg = na, pg = Object.prototype, hg = pg.hasOwnProperty;
function mg(e) {
  var t = this.__data__;
  return vg ? t[e] !== void 0 : hg.call(t, e);
}
var gg = mg, yg = na, bg = "__lodash_hash_undefined__";
function wg(e, t) {
  var r = this.__data__;
  return this.size += this.has(e) ? 0 : 1, r[e] = yg && t === void 0 ? bg : t, this;
}
var _g = wg, Dg = og, Ag = sg, xg = dg, Cg = gg, Mg = _g;
function ln(e) {
...
ln.prototype.clear = Dg;
ln.prototype.delete = Ag;
ln.prototype.get = xg;
ln.prototype.has = Cg;
ln.prototype.set = Mg;
var Og = ln;
...
var oa = Tg, Pg = oa, $g = Array.prototype, Yg = $g.splice;
function Ng(e) {
  var t = this.__data__, r = Pg(t, e);
  if (r < 0)
    return !1;
  var n = t.length - 1;
  return r == n ? t.pop() : Yg.call(t, r, 1), --this.size, !0;
}
var Rg = Ng, Lg = oa;
function Fg(e) {
  var t = this.__data__, r = Lg(t, e);
...
var Gg = zg, Vg = Ig, Kg = Rg, Qg = Bg, qg = jg, Zg = Gg;
function un(e) {
  var t = -1, r = e == null ? 0 : e.length;
  for (this.clear(); ++t < r; ) {
    var n = e[t];
...
un.prototype.clear = Vg;
un.prototype.delete = Kg;
un.prototype.get = Qg;
un.prototype.has = qg;
un.prototype.set = Zg;
var aa = un, Jg = Nr, Xg = Lt, ey = Jg(Xg, "Map"), Rs = ey, rl = Og, ty = aa, ry = Rs;
function ny() {
...
var wy = by, _y = oy, Dy = fy, Ay = py, xy = gy, Cy = wy;
function fn(e) {
  var t = -1, r = e == null ? 0 : e.length;
  for (this.clear(); ++t < r; ) {
    var n = e[t];
...
var ia = pb, hb = Su, mb = Bs, gb = Mt, yb = Us, bb = Hs, wb = ia;
function _b(e, t, r) {
  t = hb(t, e);
  ...
  return a || ++n != o ? a : (o = e == null ? 0 : e.length, !!o && bb(o) && yb(s, o) && (gb(e) || mb(e)));
}
...
var b0 = y0, w0 = g0, _0 = Nu, D0 = b0, A0 = 1, x0 = 2;
function C0(e, t, r, n, o, a) {
  ...
  for (a.set(e, t), a.set(t, e); ++f < i; ) {
    var g = e[f], b = t[f];
    if (n)
      var D = s ? n(b, g, f, t, e, a) : n(g, b, f, e, t, a);
    if (D !== void 0) {
      if (D)
        continue;
      d = !1;
    ...
    if (h) {
      if (!_0(t, function(y, F) {
        if (!D0(h, F) && (g === y || o(g, y, r, n, a)))
          return h.push(F);
      })) {
        d = !1;
        break;
...
var gw = mw;
(function(e, t) {
  var r = Lt, n = gw, o = t && !t.nodeType && t, a = o && !0 && e && !e.nodeType && e, s = a && a.exports === o, i = s ? r.Buffer : void 0, l = i ? i.isBuffer : void 0, c = l || n;
  e.exports = c;
})(hw, rn);
...
var m1 = h1, g1 = Yr, y1 = Hs;
function b1(e) {
  return e != null && y1(e.length) && !g1(e);
}
var qn = b1, w1 = Fu, _1 = m1, D1 = qn;
function A1(e) {
...
function T1(e, t, r, n, o, a) {
  ...
  for (var D = s; ++f < l; ) {
    ...
    var y = e[d], F = t[d];
    if (n)
      var L = s ? n(F, y, d, t, e, a) : n(y, F, d, e, t, a);
    if (!(L === void 0 ? y === F || o(y, F, r, n, a) : L)) {
      b = !1;
      break;
    }
    D || (D = d == "constructor");
...
function c_(e, t, r, n, o, a) {
  ...
  if (!(r & i_)) {
    ...
    if (h || g) {
      var b = h ? e.value() : e, D = g ? t.value() : t;
      return a || (a = new xa()), o(b, D, r, n, a);
    }
  }
...
var gD = mD, yD = gD, bD = yD(), Ku = bD, wD = Ku, _D = Gs;
function DD(e, t) {
  return e && wD(e, t, _D);
}
var Qu = DD, AD = qn;
...
var kA = OA, IA = AA, EA = kA, SA = EA(IA), TA = SA, PA = Vs, $A = gA, YA = TA;
function NA(e, t) {
...
}(), hx = px, mx = Bu, gx = mx(Object.getPrototypeOf, Object), ef = gx, yx = hx, bx = ef, wx = zs;
function _x(e) {
...
function nC(e, t, r, n, o, a, s) {
  ...
  if (f) {
    var d = Nl(l), h = !d && Zx(l), g = !d && !h && tC(l);
    u = l, d || h || g ? Nl(i) ? u = i : qx(i) ? u = Kx(i) : h ? (f = !1, u = Gx(l, !0)) : g ? (f = !1, u = Vx(l, !0)) : u = [] : eC(l) || Yl(l) ? (u = i, Yl(i) ? u = rC(i) : (!Xx(i) || Jx(i)) && (u = Qx(l))) : f = !1;
  }
...
var gC = mC, yC = of, bC = gC, wC = bC(function(e, t, r, n) {
  yC(e, t, r, n);
...
function iM(e, t) {
  ...
  var b = Tr(g, t), D = /* @__PURE__ */ new Date(0);
...
function mM({
  ...
  let y = t.numDays - f + 1, F = t.numDays - y + 1, L = Math.floor((y - 1) / Ke + 1), E = 1, x = t.numWeeks, V = 1, I = t.month, C = t.year;
  const B = /* @__PURE__ */ new Date(), j = B.getDate(), K = B.getMonth() + 1, _ = B.getFullYear();
  for (let U = 1; U <= lO; U++) {
    for (let oe = 1, Q = a; oe <= Ke; oe++, Q += Q === Ke ? 1 - Ke : 1) {
      d && Q === s && (y = 1, F = e.numDays, L = Math.floor((y - 1) / Ke + 1), E = Math.floor((c - y) / Ke + 1), x = 1, V = u, I = e.month, C = e.year, d = !1, h = !0);
      const re = n.getDateFromParams(C, I, y, 0, 0, 0, 0), ee = n.getDateFromParams(C, I, y, 12, 0, 0, 0), ie = n.getDateFromParams(
        ...
        59,
        999
      ), he = re, Y = `${_e(C, 4)}-${_e(I, 2)}-${_e(y, 2)}`, de = oe, q = Ke - oe, Ie = l[U - 1], ge = i[U - 1], Se = y === j && I === K && C === _, De = h && y === 1, Me = h && y === c, Ne = U === 1, Re = U === u, lt = oe === 1, Ze = oe === Ke, v = xf(C, I, y);
      o.push({
        locale: n,
        id: Y,
        position: ++b,
        label: y.toString(),
        ariaLabel: D.format(new Date(C, I - 1, y)),
        day: y,
        dayFromEnd: F,
        weekday: Q,
        weekdayPosition: de,
      ...
      }), h && Me ? (h = !1, g = !0, y = 1, F = c, L = 1, E = Math.floor((c - y) / Ke + 1), x = 1, V = r.numWeeks, I = r.month, C = r.year) : (y++, F--, L = Math.floor((y - 1) / Ke + 1), E = Math.floor((c - y) / Ke + 1));
    }
    x++, V--;
  }
  return o;
...
function AM(e, t) {
  const { month: r, year: n, showWeeknumbers: o, showIsoWeeknumbers: a } = e, s = new Date(n, r - 1, 15), i = t.getMonthParts(r, n), l = t.getPrevMonthParts(r, n), c = t.getNextMonthParts(r, n), u = mM({ monthComps: i, prevMonthComps: l, nextMonthComps: c }, t), f = gM(u, o, a, t), d = yM(f[0], t);
  return {
    id: hf(e),
    month: r,
    year: n,
...
}, ts = an(zM), GM = A(() => vA(ts.locales, (e) => (e.masks = Wn(e.masks, ts.masks), e))), fr = (e) => typeof window < "u" && lf(window.__vcalendar__, e) ? Cr(window.__vcalendar__, e) : Cr(ts, e), VM = 12, KM = 5;
function QM(e, t) {
...
var Ur = /* @__PURE__ */ ((e) => (e.Any = "any", e.All = "all", e))(Ur || {}), mf = /* @__PURE__ */ ((e) => (e.Days = "days", e.Weeks = "weeks", e.Months = "months", e.Years = "years", e))(mf || {}), gf = /* @__PURE__ */ ((e) => (e.Days = "days", e.Weekdays = "weekdays", e.Weeks = "weeks", e.Months = "months", e.Years = "years", e))(gf || {}), yf = /* @__PURE__ */ ((e) => (e.OrdinalWeekdays = "ordinalWeekdays", e))(yf || {});
class qM {
  constructor(t, r, n) {
...
class Fo {
  ...
  getObjectRules(t) {
    ...
    if (t.every && ($t(t.every) && (t.every = [1, `${t.every}s`]), wt(t.every))) {
      const [n = 1, o = mf.Days] = t.every;
      r.push(new qM(o, n, this.from));
    }
    return Object.values(gf).forEach((n) => {
...
function mO(e, t) {
  ...
  const n = r.getMilliseconds(), o = r.getSeconds(), a = r.getMinutes(), s = r.getHours(), i = n + o * bf + a * wf + s * _f, l = r.getMonth() + 1, c = r.getFullYear(), u = t.getMonthParts(l, c), f = r.getDate(), d = u.numDays - f + 1, h = r.getDay() + 1, g = Math.floor((f - 1) / 7 + 1), b = Math.floor((u.numDays - f) / 7 + 1), D = Math.ceil(
    (f + Math.abs(u.firstWeekday - u.firstDayOfWeek)) / 7
  ), y = u.numWeeks - D + 1, F = u.weeknumbers[D], L = xf(c, l, f);
  return {
    milliseconds: n,
    seconds: o,
    minutes: a,
...
function Ef(e) {
  ...
  const l = (g) => {
    ...
    i && !yo(g.currentTarget, g.relatedTarget) && (i = !1, (a || o && !s) && zn(e));
  }, h = {};
  switch (e.visibility) {
    case "click":
      h.click = l;
...
function TO(e) {
  const t = be(!1), r = A(() => t.value ? "dark" : "light");
  let n, o;
  function a(h) {
    t.value = h.matches;
  }
...
function Yf(e) {
  const t = A(() => e.color ?? ""), r = A(() => e.isDark ?? !1), { displayMode: n } = TO(r), o = A(() => new BO(t.value)), a = A(() => {
  ...
  }), s = A(() => a.value.masks), i = A(() => e.minDate), l = A(() => e.maxDate), c = A(() => {
...
function WO(e, { slots: t, emit: r }) {
  ...
  const {
    ...
    disabledAttribute: x,
    disabledDates: V
  } = UO(e), I = A(() => e.rows * e.columns), C = A(() => e.step || I.value), B = A(() => sf(u.value) ?? null), j = A(() => jr(u.value) ?? null), K = A(
    () => e.minPage || (L.value ? q(L.value) : null)
  ), _ = A(
    () => e.maxPage || (E.value ? q(E.value) : null)
  ), U = A(() => e.navVisibility), oe = A(() => !!e.showWeeknumbers), Q = A(() => !!e.showIsoWeeknumbers), re = A(() => c.value === "monthly"), ee = A(() => c.value === "weekly"), ie = A(() => c.value === "daily"), he = () => {
  ...
  }), lt = A(() => De.value.reduce((P, p) => (P[p.dayIndex] = { day: p, cells: [] }, P[p.dayIndex].cells.push(...Re.value.getCells(p)), P), {})), Ze = (P, p) => {
    ...
    return fe || (es(Xe, K.value) ? Xe = K.value : Ro(ct, _.value) && (Xe = de(_.value, 1 - I.value)), ct = de(Xe, I.value - 1)), { fromPage: Xe, toPage: ct };
  }, O = (P, p, k = "") => {
    if (k === "none" || k === "fade")
      return k;
    ...
    const { position: z = 1, force: fe = !1, transition: Ee } = P, Xe = Yt(P.page) ? P.page : m(), { fromPage: ct } = w(Xe, {
      position: z,
      force: fe
    }), Fr = [];
    for (let Br = 0; Br < I.value; Br++) {
      const ca = de(ct, Br), nt = Br + 1, ua = Math.ceil(nt / e.columns), Jn = e.rows - ua + 1, mn = nt % e.columns || e.columns, gn = e.columns - mn + 1, Qf = Ze(mn, gn);
      Fr.push(
        y.value.getPage({
          ...ca,
          view: c.value,
    ...
    const p = B.value ?? q(/* @__PURE__ */ new Date());
    return de(p, P);
  }, H = (P, p = {}) => {
    const k = Yt(P) ? P : q(P);
    return Object.assign(
      ...
      c.value,
      y.value
    ).map((fe) => wM(fe, K.value, _.value)).some((fe) => fe);
  }, $ = (P, p = {}) => H(N(P), p), R = A(() => $(-C.value)), S = A(() => $(C.value)), W = async (P, p = {}) => !p.force && !H(P, p) ? !1 : (p.fromPage && !_M(p.fromPage, B.value) && (zn({ id: i.value, hideDelay: 0 }), p.view && (IO("view", 10), c.value = p.view), await M({
    ...p,
    page: p.fromPage,
    position: 1,
    force: !0
  }), r("did-move", u.value)), !0), X = (P, p = {}) => W(N(P), p), Z = () => X(-C.value), ae = () => X(C.value), ce = (P) => {
...
const zO = /* @__PURE__ */ We({
  ...
  setup(e, { emit: t }) {
    ...
    async function D(Y = {}) {
      s.force || (Y.force && (s.force = !0), g(Y.showDelay ?? e.showDelay, () => {
    ...
    function y(Y = {}) {
      a && (Y.target && !b(Y.target) || s.force || (Y.force && (s.force = !0), g(Y.hideDelay ?? e.hideDelay, () => {
    ...
    function C() {
      lr(document, "keydown", E), lr(document, "click", L), lr(document, "show-popover", x), lr(document, "hide-popover", V), lr(document, "toggle-popover", I);
    }
    function B() {
      ir(document, "keydown", E), ir(document, "click", L), ir(document, "show-popover", x), ir(document, "hide-popover", V), ir(document, "toggle-popover", I);
    }
    function j(Y) {
      t("before-show", Y);
    }
...
const ri = /* @__PURE__ */ hr(zO, [["render", GO]]), VO = { class: "vc-day-popover-row" }, KO = {
  ...
  viewBox: "0 0 24 24"
}, nk = /* @__PURE__ */ J("polyline", { points: "9 18 15 12 9 6" }, null, -1), ok = [
  nk
];
function ak(e, t) {
...
const sk = /* @__PURE__ */ hr(tk, [["render", ak]]), ik = {}, lk = {
  ...
  "stroke-linejoin": "round",
  viewBox: "0 0 24 24"
}, ck = /* @__PURE__ */ J("polyline", { points: "15 18 9 12 15 6" }, null, -1), uk = [
  ck
];
function fk(e, t) {
...
const dk = /* @__PURE__ */ hr(ik, [["render", fk]]), vk = {}, pk = {
  ...
  "stroke-linejoin": "round",
  viewBox: "0 0 24 24"
}, hk = /* @__PURE__ */ J("polyline", { points: "6 9 12 15 18 9" }, null, -1), mk = [
  hk
];
function gk(e, t) {
  return G(), ne("svg", pk, mk);
}
const yk = /* @__PURE__ */ hr(vk, [["render", gk]]), bk = {}, wk = {
  fill: "none",
  "stroke-linecap": "round",
  "stroke-linejoin": "round",
  "stroke-width": "2",
  viewBox: "0 0 24 24"
}, _k = /* @__PURE__ */ J("path", { d: "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" }, null, -1), Dk = [
  _k
];
function Ak(e, t) {
...
const xk = /* @__PURE__ */ hr(bk, [["render", Ak]]), Ck = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  setup(e) {
    const t = e, r = A(() => t.width || t.size), n = A(() => t.height || t.size), o = A(() => Ck[`Icon${t.name}`]);
  ...
  setup(e) {
    ...
    }), u = A(() => t.page.titlePosition.includes("left")), f = A(() => t.page.titlePosition.includes("right")), d = A(() => t.layout ? t.layout : u.value ? "tu-pn" : f.value ? "pn-tu" : "p-tu-n;"), h = A(() => ({
      prev: d.value.includes("p") && !t.hideArrows,
      title: d.value.includes("t") && !t.hideTitle,
      next: d.value.includes("n") && !t.hideArrows
    })), g = A(() => ({ gridTemplateColumns: d.value.split("").map((D) => {
      switch (D) {
        case "p":
          return "[prev] auto";
        case "n":
...
const Sk = { class: "vc-nav-header" }, Tk = ["disabled"], Pk = ["disabled"], $k = { class: "vc-nav-items" }, Yk = ["data-id", "aria-label", "disabled", "onClick", "onKeydown"], Nk = /* @__PURE__ */ We({
  ...
  setup(e) {
    ...
    function D() {
      ee.value && (s.value && F(), E());
    }
    function y() {
      ie.value && (s.value && L(), x());
    }
    function F() {
      l.value--;
    }
    ...
    const V = A(
      ...
      () => s.value ? V.value : K.value
    ), ee = A(
      () => s.value ? C.value : U.value
    ), ie = A(
      () => s.value ? j.value : Q.value
    ), he = A(() => sf(K.value.map((q) => q.year))), Y = A(() => jr(K.value.map((q) => q.year))), de = A(() => s.value ? l.value : `${he.value} - ${Y.value}`);
    return Wc(() => {
      ...
      J("div", Sk, [
        J("button", {
          ...
          disabled: !T(ee),
          onClick: D,
          onKeydown: Ie[0] || (Ie[0] = (ge) => T(co)(ge, D))
        }, [
          le(ht, {
        ...
        J("button", {
          ...
          onClick: h,
          onKeydown: Ie[1] || (Ie[1] = (ge) => T(co)(ge, h))
        }, Le(T(de)), 33),
        J("button", {
          type: "button",
          ...
          disabled: !T(ie),
          onClick: y,
          onKeydown: Ie[2] || (Ie[2] = (ge) => T(co)(ge, y))
        }, [
          le(ht, {
      ...
      J("div", $k, [
        (G(!0), ne(we, null, gt(T(re), (ge) => (G(), ne("button", {
          key: ge.label,
          type: "button",
          "data-id": ge.id,
          ...
          onClick: ge.click,
          onKeydown: (Se) => T(co)(Se, ge.click)
        }, Le(ge.label), 43, Yk))), 128))
      ])
    ], 512));
  }
}), jf = /* @__PURE__ */ We({
  ...
  setup(e) {
    const {
      ...
      onDayFocusout: c,
      onDayKeydown: u
    } = Rr(), f = A(() => e.day), d = A(() => n.value.getCells(f.value)), h = A(
      () => d.value.map((Q) => Q.data)
    ), g = A(() => ({
      ...f.value,
      attributes: h.value,
      attributeCells: d.value
    }));
    function b({ data: Q }, { popovers: re }) {
      const { key: ee, customData: ie, popover: he } = Q;
      if (!he)
        return;
      const Y = Sl(
        {
    ...
    const D = A(() => {
      ...
      return d.value.forEach((re) => {
        r.value.render(re, Q), b(re, Q);
      }), Q;
    }), y = A(() => D.value.highlights), F = A(() => !!Ht(y.value)), L = A(() => D.value.content), E = A(() => D.value.dots), x = A(() => !!Ht(E.value)), V = A(() => D.value.bars), I = A(() => !!Ht(V.value)), C = A(() => D.value.popovers), B = A(
      () => C.value.map((Q) => Q.attribute)
    ), j = Lf("day-content"), K = A(() => [
      "vc-day",
      ...f.value.classes,
...
function Wk(e, t, r, n, o, a) {
  ...
  return G(), ne("div", {
    ...
    e.hasHighlights ? (G(), ne("div", Fk, [
      (G(!0), ne(we, null, gt(e.highlights, ({ key: l, wrapperClass: c, class: u, style: f }) => (G(), ne("div", {
        key: l,
        class: xe(c)
      }, [
        J("div", {
    ...
    e.hasDots ? (G(), ne("div", Bk, [
      J("div", Uk, [
        (G(!0), ne(we, null, gt(e.dots, ({ key: l, class: c, style: u }) => (G(), ne("span", {
          key: l,
          class: xe(c),
          style: jt(u)
        }, null, 6))), 128))
    ...
    e.hasBars ? (G(), ne("div", Hk, [
      J("div", jk, [
        (G(!0), ne(we, null, gt(e.bars, ({ key: l, class: c, style: u }) => (G(), ne("span", {
          key: l,
          class: xe(c),
          style: jt(u)
        }, null, 6))), 128))
  ...
  setup(e) {
    ...
    return (n, o) => (G(), ne("div", {
      ...
      J("div", {
        ...
        J("div", Gk, [
          (G(!0), ne(we, null, gt(T(t).weekdays, ({ weekday: a, label: s }, i) => (G(), ne("div", {
            key: i,
            class: xe(`vc-weekday vc-weekday-${a}`)
          }, Le(s), 3))), 128))
        ]),
        (G(!0), ne(we, null, gt(T(t).viewWeeks, (a) => (G(), ne("div", {
          ...
          (G(!0), ne(we, null, gt(a.days, (s) => (G(), Ve(zk, {
            key: s.id,
            day: s
          }, null, 8, ["day"]))), 128))
        ]))), 128))
...
function Jk(e, t, r, n, o, a) {
  ...
  return G(), ne(we, null, [
    J("div", $r({ "data-helptext": "Press the arrow keys to navigate by day, Home and End to navigate to week ends, PageUp and PageDown to navigate by month, Alt+PageUp and Alt+PageDown to navigate by year" }, e.$attrs, {
      class: [
        "vc-container",
        `vc-${e.view}`,
        `vc-${e.color}`,
        ...
        le(ea, {
          ...
          default: Ye(() => [
            (G(), ne("div", {
              ...
              (G(!0), ne(we, null, gt(e.pages, (d) => (G(), Ve(c, {
                key: d.id,
                page: d
              }, {
                default: Ye(() => [
...
function rI(e, { emit: t, slots: r }) {
  ...
  let g, b, D = !0;
  const y = A(() => e.isRange || e.modelModifiers.range === !0), F = A(
    () => y.value && c.value != null ? c.value.start : null
  ), L = A(
    () => y.value && c.value != null ? c.value.end : null
  ), E = A(() => e.mode.toLowerCase() === "date"), x = A(
    () => e.mode.toLowerCase() === "datetime"
  ), V = A(() => e.mode.toLowerCase() === "time"), I = A(() => !!u.value), C = A(() => {
    let p = "date";
    ...
    () => $(u.value ?? c.value)
  ), j = A(() => V.value ? e.is24hr ? a.value.inputTime24hr : a.value.inputTime : x.value ? e.is24hr ? a.value.inputDateTime24hr : a.value.inputDateTime : a.value.input), K = A(() => /[Hh]/g.test(j.value)), _ = A(
  ...
  function lt(p, k, z, fe) {
    ...
    if (De(p)) {
      const Ee = o.value.toDate(p.start, {
        ...
        ...k[1],
        fillDate: L.value ?? void 0,
        patch: z
      });
      return mr({ start: Ee, end: Xe }, fe);
    }
  ...
  function m(p, {
    ...
    return mn && (D = !1, t(ct ? "drag" : "update:modelValue", gn), xr(() => D = !0)), Xe && !ct && ze(), Ee && w(), Br && xr(() => He(Fr ?? "start")), gn;
  }
  function w() {
    xr(() => {
      const p = ge({
  ...
  function ye(p, k) {
    !I.value || b == null || (b.end = p.date, v(mr(b), {
      patch: "date",
      formatInput: !0
    }));
  }
...
function aI(e) {
  ...
  function f(_) {
    ...
    let U = null;
    if (n.value) {
      const oe = d.value ? _ : a.value[0], Q = d.value ? a.value[1] : _;
      U = { start: oe, end: Q };
    } else
      U = _;
    u(U, {
  ...
  const d = A(() => e.position === 0), h = A(
    () => a.value[e.position] || { isValid: !1 }
  ), g = A(() => Js(h.value)), b = A(() => !!h.value.isValid), D = A(() => !l.value && b.value), y = A(() => {
    if (!g.value)
      return null;
    ...
    set(_) {
      ...
      let U = F.value;
      _ && U >= 12 ? U -= 12 : !_ && U < 12 && (U += 12), f({ hours: U });
    }
  }), I = A(
    () => AO(h.value, s.value[e.position])
  ), C = A(() => nI.filter(
    (_) => I.value.hours.some((U) => U.value === _.value)
  )), B = A(() => oI.filter(
    (_) => I.value.hours.some((U) => U.value === _.value)
  )), j = A(() => i.value ? I.value.hours : V.value ? C.value : B.value), K = A(() => {
    const _ = [];
    return Ht(C.value) && _.push({ value: !0, label: "AM" }), Ht(B.value) && _.push({ value: !1, label: "PM" }), _;
  });
  return {
    ...t,
    showHeader: D,
...
const sI = ["value"], iI = ["value", "disabled"], lI = {
  ...
  setup(e) {
    ...
    return (n, o) => (G(), ne("div", {
      ...
      J("select", $r(n.$attrs, {
        ...
        (G(!0), ne(we, null, gt(e.options, (a) => (G(), ne("option", {
          key: a.value,
          value: a.value,
          disabled: a.disabled
        }, Le(a.label), 9, iI))), 128))
...
}, fI = { class: "vc-time-weekday" }, dI = { class: "vc-time-month" }, vI = { class: "vc-time-day" }, pI = { class: "vc-time-year" }, hI = { class: "vc-time-select-group" }, mI = /* @__PURE__ */ J("span", { class: "vc-time-colon" }, ":", -1), gI = /* @__PURE__ */ J("span", { class: "vc-time-colon" }, ":", -1), yI = /* @__PURE__ */ J("span", { class: "vc-time-decimal" }, ".", -1), sc = /* @__PURE__ */ We({
  __name: "TimePicker",
  props: {
    position: null
  },
  setup(e, { expose: t }) {
    ...
    return (L, E) => (G(), ne("div", {
      ...
      le(ht, { name: "time-header" }, {
        default: Ye(() => [
          T(y) && T(s) ? (G(), ne("div", uI, [
            J("span", fI, Le(T(o).formatDate(T(s), "WWW")), 1),
            J("span", dI, Le(T(o).formatDate(T(s), "MMM")), 1),
            J("span", vI, Le(T(o).formatDate(T(s), "D")), 1),
            J("span", pI, Le(T(o).formatDate(T(s), "YYYY")), 1)
          ])) : Fe("", !0)
        ]),
        _: 1
      }),
      J("div", hI, [
        ...
        T(D) ? Fe("", !0) : (G(), Ve(An, {
          key: 3,
          modelValue: T(g),
          "onUpdate:modelValue": E[4] || (E[4] = (x) => Pe(g) ? g.value = x : null),
          options: T(b)
        }, null, 8, ["modelValue", "options"]))
      ])
    ], 2));
  ...
  setup(e) {
    ...
    return (d, h) => T(s) ? (G(), ne("div", {
      ...
      (G(!0), ne(we, null, gt(T(f), (g) => (G(), Ve(sc, {
        key: g,
        position: g
      }, null, 8, ["position"]))), 128))
    ], 2)) : (G(), Ve(Xk, {
      ...
      footer: Ye(() => [
        T(a) ? (G(!0), ne(we, { key: 0 }, gt(T(f), (g) => (G(), Ve(sc, {
          key: g,
          position: g
...
const jI = "data:image/png;base64,", WI = '*,:before,:after{--tw-border-spacing-x: 0;--tw-border-spacing-y: 0;--tw-translate-x: 0;--tw-translate-y: 0;--tw-rotate: 0;--tw-skew-x: 0;--tw-skew-y: 0;--tw-scale-x: 1;--tw-scale-y: 1;--tw-pan-x: ;--tw-pan-y: ;--tw-pinch-zoom: ;--tw-scroll-snap-strictness: proximity;--tw-gradient-from-position: ;--tw-gradient-via-position: ;--tw-gradient-to-position: ;--tw-ordinal: ;--tw-slashed-zero: ;--tw-numeric-figure: ;--tw-numeric-spacing: ;--tw-numeric-fraction: ;--tw-ring-inset: ;--tw-ring-offset-width: 0px;--tw-ring-offset-color: #fff;--tw-ring-color: rgb(59 130 246 / .5);--tw-ring-offset-shadow: 0 0 #0000;--tw-ring-shadow: 0 0 #0000;--tw-shadow: 0 0 #0000;--tw-shadow-colored: 0 0 #0000;--tw-blur: ;--tw-brightness: ;--tw-contrast: ;--tw-grayscale: ;--tw-hue-rotate: ;--tw-invert: ;--tw-saturate: ;--tw-sepia: ;--tw-drop-shadow: ;--tw-backdrop-blur: ;--tw-backdrop-brightness: ;--tw-backdrop-contrast: ;--tw-backdrop-grayscale: ;--tw-backdrop-hue-rotate: ;--tw-backdrop-invert: ;--tw-backdrop-opacity: ;--tw-backdrop-saturate: ;--tw-backdrop-sepia: }::backdrop{--tw-border-spacing-x: 0;--tw-border-spacing-y: 0;--tw-translate-x: 0;--tw-translate-y: 0;--tw-rotate: 0;--tw-skew-x: 0;--tw-skew-y: 0;--tw-scale-x: 1;--tw-scale-y: 1;--tw-pan-x: ;--tw-pan-y: ;--tw-pinch-zoom: ;--tw-scroll-snap-strictness: proximity;--tw-gradient-from-position: ;--tw-gradient-via-position: ;--tw-gradient-to-position: ;--tw-ordinal: ;--tw-slashed-zero: ;--tw-numeric-figure: ;--tw-numeric-spacing: ;--tw-numeric-fraction: ;--tw-ring-inset: ;--tw-ring-offset-width: 0px;--tw-ring-offset-color: #fff;--tw-ring-color: rgb(59 130 246 / .5);--tw-ring-offset-shadow: 0 0 #0000;--tw-ring-shadow: 0 0 #0000;--tw-shadow: 0 0 #0000;--tw-shadow-colored: 0 0 #0000;--tw-blur: ;--tw-brightness: ;--tw-contrast: ;--tw-grayscale: ;--tw-hue-rotate: ;--tw-invert: ;--tw-saturate: ;--tw-sepia: ;--tw-drop-shadow: ;--tw-backdrop-blur: ;--tw-backdrop-brightness: ;--tw-backdrop-contrast: ;--tw-backdrop-grayscale: ;--tw-backdrop-hue-rotate: ;--tw-backdrop-invert: ;--tw-backdrop-opacity: ;--tw-backdrop-saturate: ;--tw-backdrop-sepia: }.flex{display:flex!important}.h-6{height:1.5rem!important}.h-2{height:.5rem!important}.h-4{height:1rem!important}.h-5{height:1.25rem!important}.w-full{width:100%!important}.w-2{width:.5rem!important}.w-4{width:1rem!important}.w-5{width:1.25rem!important}.w-fit{width:-moz-fit-content!important;width:fit-content!important}.cursor-pointer{cursor:pointer!important}.appearance-none{-webkit-appearance:none!important;-moz-appearance:none!important;appearance:none!important}.flex-col{flex-direction:column!important}.flex-wrap{flex-wrap:wrap!important}.items-end{align-items:flex-end!important}.items-center{align-items:center!important}.justify-center{justify-content:center!important}.justify-between{justify-content:space-between!important}.gap-1{gap:.25rem!important}.gap-2{gap:.5rem!important}.gap-4{gap:1rem!important}.break-words{overflow-wrap:break-word!important}.rounded-full{border-radius:9999px!important}.rounded-lg{border-radius:.5rem!important}.border{border-width:1px!important}.border-solid{border-style:solid!important}.border-none{border-style:none!important}.bg-booked{--tw-bg-opacity: 1 !important;background-color:rgb(150 3 3 / var(--tw-bg-opacity))!important}.bg-primary-blue\\/90{background-color:#0987c5e6!important}.bg-secondary-braun{--tw-bg-opacity: 1 !important;background-color:rgb(216 189 0 / var(--tw-bg-opacity))!important}.bg-white{--tw-bg-opacity: 1 !important;background-color:rgb(255 255 255 / var(--tw-bg-opacity))!important}.object-contain{-o-object-fit:contain!important;object-fit:contain!important}.p-2{padding:.5rem!important}.p-4{padding:1rem!important}.px-2{padding-left:.5rem!important;padding-right:.5rem!important}.text-center{text-align:center!important}.text-sm{font-size:.875rem!important;line-height:1.25rem!important}.text-xs{font-size:.75rem!important;line-height:1rem!important}.font-medium{font-weight:500!important}.font-normal{font-weight:400!important}.font-semibold{font-weight:600!important}.tabular-nums{--tw-numeric-spacing: tabular-nums !important;font-variant-numeric:var(--tw-ordinal) var(--tw-slashed-zero) var(--tw-numeric-figure) var(--tw-numeric-spacing) var(--tw-numeric-fraction)!important}.text-gray-700{--tw-text-opacity: 1 !important;color:rgb(55 65 81 / var(--tw-text-opacity))!important}.text-primary-braun{--tw-text-opacity: 1 !important;color:rgb(107 63 18 / var(--tw-text-opacity))!important}.text-red-500{--tw-text-opacity: 1 !important;color:rgb(239 68 68 / var(--tw-text-opacity))!important}.text-white{--tw-text-opacity: 1 !important;color:rgb(255 255 255 / var(--tw-text-opacity))!important}.no-underline{text-decoration-line:none!important}.shadow-md{--tw-shadow: 0 4px 6px -1px rgb(0 0 0 / .1), 0 2px 4px -2px rgb(0 0 0 / .1) !important;--tw-shadow-colored: 0 4px 6px -1px var(--tw-shadow-color), 0 2px 4px -2px var(--tw-shadow-color) !important;box-shadow:var(--tw-ring-offset-shadow, 0 0 #0000),var(--tw-ring-shadow, 0 0 #0000),var(--tw-shadow)!important}.duration-300{transition-duration:.3s!important}.hover\\:bg-primary-blue:hover{--tw-bg-opacity: 1 !important;background-color:rgb(9 135 197 / var(--tw-bg-opacity))!important}.hover\\:bg-secondary-blue\\/40:hover{background-color:#75bce166!important}@media not all and (min-width: 768px){.max-md\\:flex-wrap{flex-wrap:wrap!important}}@media not all and (min-width: 640px){.max-sm\\:flex-wrap{flex-wrap:wrap!important}}.vc-popover-content-wrapper{--popover-horizontal-content-offset: 8px;--popover-vertical-content-offset: 10px;--popover-caret-horizontal-offset: 18px;--popover-caret-vertical-offset: 8px;position:absolute;display:block;outline:none;z-index:10}.vc-popover-content-wrapper:not(.is-interactive){pointer-events:none}.vc-popover-content{position:relative;color:var(--vc-popover-content-color);font-weight:var(--vc-font-medium);background-color:var(--vc-popover-content-bg);border:1px solid;border-color:var(--vc-popover-content-border);border-radius:var(--vc-rounded-lg);padding:4px;outline:none;z-index:10;box-shadow:var(--vc-shadow-lg)}.vc-popover-content.direction-bottom{margin-top:var(--popover-vertical-content-offset)}.vc-popover-content.direction-top{margin-bottom:var(--popover-vertical-content-offset)}.vc-popover-content.direction-left{margin-right:var(--popover-horizontal-content-offset)}.vc-popover-content.direction-right{margin-left:var(--popover-horizontal-content-offset)}.vc-popover-caret{content:"";position:absolute;display:block;width:12px;height:12px;border-top:inherit;border-left:inherit;background-color:inherit;z-index:-1}.vc-popover-caret.direction-bottom{top:0}.vc-popover-caret.direction-bottom.align-left{transform:translateY(-50%) rotate(45deg)}.vc-popover-caret.direction-bottom.align-center{transform:translate(-50%) translateY(-50%) rotate(45deg)}.vc-popover-caret.direction-bottom.align-right{transform:translateY(-50%) rotate(45deg)}.vc-popover-caret.direction-top{top:100%}.vc-popover-caret.direction-top.align-left{transform:translateY(-50%) rotate(-135deg)}.vc-popover-caret.direction-top.align-center{transform:translate(-50%) translateY(-50%) rotate(-135deg)}.vc-popover-caret.direction-top.align-right{transform:translateY(-50%) rotate(-135deg)}.vc-popover-caret.direction-left{left:100%}.vc-popover-caret.direction-left.align-top{transform:translate(-50%) rotate(135deg)}.vc-popover-caret.direction-left.align-middle{transform:translateY(-50%) translate(-50%) rotate(135deg)}.vc-popover-caret.direction-left.align-bottom{transform:translate(-50%) rotate(135deg)}.vc-popover-caret.direction-right{left:0}.vc-popover-caret.direction-right.align-top{transform:translate(-50%) rotate(-45deg)}.vc-popover-caret.direction-right.align-middle{transform:translateY(-50%) translate(-50%) rotate(-45deg)}.vc-popover-caret.direction-right.align-bottom{transform:translate(-50%) rotate(-45deg)}.vc-popover-caret.align-left{left:var(--popover-caret-horizontal-offset)}.vc-popover-caret.align-center{left:50%}.vc-popover-caret.align-right{right:var(--popover-caret-horizontal-offset)}.vc-popover-caret.align-top{top:var(--popover-caret-vertical-offset)}.vc-popover-caret.align-middle{top:50%}.vc-popover-caret.align-bottom{bottom:var(--popover-caret-vertical-offset)}.vc-day-popover-row{display:flex;align-items:center;transition:var(--vc-day-content-transition)}.vc-day-popover-row-indicator{display:flex;justify-content:center;align-items:center;flex-grow:0;width:15px}.vc-day-popover-row-indicator span{transition:var(--vc-day-content-transition)}.vc-day-popover-row-label{display:flex;align-items:center;flex-wrap:none;flex-grow:1;width:-moz-max-content;width:max-content;margin-left:4px;margin-right:4px;font-size:var(--vc-text-xs);line-height:var(--vc-leading-normal)}.vc-day-popover-row-highlight{width:8px;height:5px;border-radius:3px}.vc-day-popover-row-bar{width:10px;height:3px}.vc-base-icon{display:inline-block;stroke:currentColor;stroke-width:2;fill:none}.vc-header{display:grid;grid-gap:4px;align-items:center;height:30px;margin-top:10px;padding-left:10px;padding-right:10px}.vc-header.is-lg{font-size:var(--vc-text-lg)}.vc-header.is-xl{font-size:var(--vc-text-xl)}.vc-header.is-2xl{font-size:var(--vc-text-2xl)}.vc-header .vc-title-wrapper{grid-row:1;grid-column:title}.vc-header .vc-prev{grid-row:1;grid-column:prev}.vc-header .vc-next{grid-row:1;grid-column:next}.vc-header .vc-title,.vc-header .vc-prev,.vc-header .vc-next{display:flex;align-items:center;border:0;border-radius:var(--vc-rounded);pointer-events:auto;-webkit-user-select:none;-moz-user-select:none;user-select:none;cursor:pointer}.vc-header .vc-title{color:var(--vc-header-title-color);font-weight:var(--vc-font-semibold);white-space:nowrap;padding:0 8px;margin:0;line-height:30px}.vc-header .vc-title:hover{opacity:.75}.vc-header .vc-arrow{display:flex;justify-content:center;align-items:center;color:var(--vc-header-arrow-color);width:28px;height:30px;margin:0;padding:0}.vc-header .vc-arrow:hover{background:var(--vc-header-arrow-hover-bg)}.vc-header .vc-arrow:disabled{opacity:.25;pointer-events:none}.vc-nav-header{display:flex;justify-content:space-between}.vc-nav-title,.vc-nav-arrow,.vc-nav-item{font-size:var(--vc-text-sm);margin:0;cursor:pointer;-webkit-user-select:none;-moz-user-select:none;user-select:none;border:0;border-radius:var(--vc-rounded);white-space:nowrap}.vc-nav-title:hover,.vc-nav-arrow:hover,.vc-nav-item:hover{background-color:var(--vc-nav-hover-bg)}.vc-nav-title:disabled,.vc-nav-arrow:disabled,.vc-nav-item:disabled{opacity:.25;pointer-events:none}.vc-nav-title{color:var(--vc-nav-title-color);font-weight:var(--vc-font-bold);line-height:var(--vc-leading-snug);height:30px;padding:0 6px}.vc-nav-arrow{display:flex;justify-content:center;align-items:center;color:var(--vc-header-arrow-color);width:26px;height:30px;padding:0}.vc-nav-items{display:grid;grid-template-columns:repeat(3,1fr);grid-row-gap:2px;grid-column-gap:5px;margin-top:2px}.vc-nav-item{width:48px;text-align:center;font-weight:var(--vc-font-semibold);line-height:var(--vc-leading-snug);padding:6px 0}.vc-nav-item.is-active{color:var(--vc-nav-item-active-color);background-color:var(--vc-nav-item-active-bg);font-weight:var(--vc-font-bold)}.vc-nav-item.is-active:not(:focus){box-shadow:var(--vc-nav-item-active-box-shadow)}.vc-nav-item.is-current{color:var(--vc-nav-item-current-color)}.vc-day{position:relative;min-height:32px;z-index:1}.vc-monthly .is-not-in-month *{opacity:0;pointer-events:none}.vc-day-layer{position:absolute;left:0;right:0;top:0;bottom:0;pointer-events:none}.vc-day-box-center-center{display:flex;justify-content:center;align-items:center;transform-origin:50% 50%}.vc-day-box-left-center{display:flex;justify-content:flex-start;align-items:center;transform-origin:0% 50%}.vc-day-box-right-center{display:flex;justify-content:flex-end;align-items:center;transform-origin:100% 50%}.vc-day-box-center-bottom{display:flex;justify-content:center;align-items:flex-end}.vc-day-content{display:flex;justify-content:center;align-items:center;font-size:var(--vc-text-sm);font-weight:var(--vc-font-medium);width:28px;height:28px;line-height:28px;border-radius:var(--vc-rounded-full);-webkit-user-select:none;-moz-user-select:none;user-select:none;cursor:pointer}.vc-day-content:hover{background-color:var(--vc-day-content-hover-bg)}.vc-day-content.vc-disabled{color:var(--vc-day-content-disabled-color)}.vc-content:not(.vc-base){font-weight:var(--vc-font-bold);color:var(--vc-content-color)}.vc-highlights{overflow:hidden;pointer-events:none;z-index:-1}.vc-highlight{width:28px;height:28px}.vc-highlight.vc-highlight-base-start{width:50%!important;border-radius:0!important;border-right-width:0!important}.vc-highlight.vc-highlight-base-end{width:50%!important;border-radius:0!important;border-left-width:0!important}.vc-highlight.vc-highlight-base-middle{width:100%;border-radius:0!important;border-left-width:0!important;border-right-width:0!important;margin:0 -1px}.vc-highlight-bg-outline,.vc-highlight-bg-none{background-color:var(--vc-highlight-outline-bg);border:2px solid;border-color:var(--vc-highlight-outline-border);border-radius:var(--vc-rounded-full)}.vc-highlight-bg-light{background-color:var(--vc-highlight-light-bg);border-radius:var(--vc-rounded-full)}.vc-highlight-bg-solid{background-color:var(--vc-highlight-solid-bg);border-radius:var(--vc-rounded-full)}.vc-highlight-content-outline,.vc-highlight-content-none{font-weight:var(--vc-font-bold);color:var(--vc-highlight-outline-content-color)}.vc-highlight-content-light{font-weight:var(--vc-font-bold);color:var(--vc-highlight-light-content-color)}.vc-highlight-content-solid{font-weight:var(--vc-font-bold);color:var(--vc-highlight-solid-content-color)}.vc-dots{display:flex;justify-content:center;align-items:center}.vc-dot{width:5px;height:5px;border-radius:9999px;transition:var(--vc-day-content-transition)}.vc-dot:not(:last-child){margin-right:3px}.vc-bars{display:flex;justify-content:flex-start;align-items:center;width:75%}.vc-bar{flex-grow:1;height:3px;transition:var(--vc-day-content-transition)}.vc-dot{background-color:var(--vc-dot-bg)}.vc-bar{background-color:var(--vc-bar-bg)}.vc-pane{min-width:250px}.vc-weeknumber{display:flex;justify-content:center;align-items:center;position:absolute}.vc-weeknumber.is-left{left:calc(var(--vc-weeknumber-offset-inside) * -1)}.vc-weeknumber.is-right{right:calc(var(--vc-weeknumber-offset-inside) * -1)}.vc-weeknumber.is-left-outside{left:calc(var(--vc-weeknumber-offset-outside) * -1)}.vc-weeknumber.is-right-outside{right:calc(var(--vc-weeknumber-offset-outside) * -1)}.vc-weeknumber-content{display:flex;justify-content:center;align-items:center;font-size:var(--vc-text-xs);font-weight:var(--vc-font-medium);font-style:italic;width:28px;height:28px;margin-top:2px;color:var(--vc-weeknumber-color);-webkit-user-select:none;-moz-user-select:none;user-select:none}.vc-weeks{position:relative;-webkit-overflow-scrolling:touch;padding:6px;min-width:232px}.vc-weeks.vc-show-weeknumbers-left{margin-left:var(--vc-weeknumber-offset-inside)}.vc-weeks.vc-show-weeknumbers-right{margin-right:var(--vc-weeknumber-offset-inside)}.vc-weekday{text-align:center;color:var(--vc-weekday-color);font-size:var(--vc-text-sm);font-weight:var(--vc-font-bold);line-height:14px;padding-top:4px;padding-bottom:8px;cursor:default;-webkit-user-select:none;-moz-user-select:none;user-select:none}.vc-week,.vc-weekdays{display:grid;grid-template-columns:repeat(7,1fr);position:relative}.vc-pane-container{width:100%;position:relative}.vc-pane-container.in-transition{overflow:hidden}.vc-pane-layout{display:grid}.vc-pane-header-wrapper{position:absolute;top:0;width:100%;pointer-events:none}.vc-day-popover-container{font-size:var(--vc-text-xs);font-weight:var(--vc-font-medium)}.vc-day-popover-header{font-size:var(--vc-text-xs);color:var(--vc-day-popover-header-color);font-weight:var(--vc-font-semibold);text-align:center}.vc-base-select{position:relative;display:flex;justify-content:center;align-items:center;height:30px;font-size:var(--vc-text-base);font-weight:var(--vc-font-medium)}.vc-base-select.vc-has-icon select{padding:0 27px 0 9px}.vc-base-select.vc-has-icon .vc-base-sizer{padding:0 28px 0 10px}.vc-base-select.vc-fit-content select{position:absolute;top:0;left:0;width:100%}.vc-base-select .vc-base-icon{position:absolute;top:6px;right:4px;opacity:.6;pointer-events:none}.vc-base-select .vc-base-sizer{font-size:var(--vc-text-base);font-weight:var(--vc-font-medium);color:transparent;padding:0 8px;margin:0}.vc-base-select select{display:inline-flex;justify-content:center;color:var(--vc-select-color);display:block;-webkit-appearance:none;-moz-appearance:none;appearance:none;background-color:var(--vc-select-bg);border-radius:var(--vc-rounded);height:30px;width:-moz-max-content;width:max-content;padding:0 7px;margin:0;line-height:var(--leading-none);text-indent:0px;background-image:none;cursor:pointer;text-align:center}.vc-base-select select:hover{background-color:var(--vc-select-hover-bg)}.vc-base-select select.vc-align-left{text-align:left}.vc-base-select select.vc-align-right{text-align:right}.vc-time-picker{display:flex;flex-direction:column;align-items:center;padding:8px 4px}.vc-time-picker.vc-invalid{pointer-events:none;opacity:.5}.vc-time-picker.vc-attached{border-top:1px solid var(--vc-time-picker-border)}.vc-time-picker>*+*{margin-top:4px}.vc-time-header{display:flex;align-items:center;font-size:var(--vc-text-sm);font-weight:var(--vc-font-semibold);text-transform:uppercase;margin-top:-4px;padding-left:4px;padding-right:4px;line-height:21px}.vc-time-select-group{display:inline-flex;align-items:center;padding:0 4px;background:var(--vc-time-select-group-bg);border-radius:var(--vc-rounded-md);border:1px solid var(--vc-time-select-group-border)}.vc-time-select-group .vc-base-icon{margin-right:4px;color:var(--vc-time-select-group-icon-color)}.vc-time-select-group select{background:transparent;padding:0 4px}.vc-time-weekday{color:var(--vc-time-weekday-color);letter-spacing:var(--tracking-wide)}.vc-time-month{color:var(--vc-time-month-color);margin-left:8px}.vc-time-day{color:var(--vc-time-day-color);margin-left:4px}.vc-time-year{color:var(--vc-time-year-color);margin-left:8px}.vc-time-colon{margin:0 1px 2px 2px}.vc-time-decimal{margin:0 0 0 1px}.vc-none-enter-active,.vc-none-leave-active{transition-duration:0s}.vc-fade-enter-active,.vc-fade-leave-active,.vc-slide-left-enter-active,.vc-slide-left-leave-active,.vc-slide-right-enter-active,.vc-slide-right-leave-active,.vc-slide-up-enter-active,.vc-slide-up-leave-active,.vc-slide-down-enter-active,.vc-slide-down-leave-active,.vc-slide-fade-enter-active,.vc-slide-fade-leave-active{transition:transform var(--vc-slide-duration) var(--vc-slide-timing),opacity var(--vc-slide-duration) var(--vc-slide-timing);backface-visibility:hidden;pointer-events:none}.vc-none-leave-active,.vc-fade-leave-active,.vc-slide-left-leave-active,.vc-slide-right-leave-active,.vc-slide-up-leave-active,.vc-slide-down-leave-active{position:absolute!important;width:100%}.vc-none-enter-from,.vc-none-leave-to,.vc-fade-enter-from,.vc-fade-leave-to,.vc-slide-left-enter-from,.vc-slide-left-leave-to,.vc-slide-right-enter-from,.vc-slide-right-leave-to,.vc-slide-up-enter-from,.vc-slide-up-leave-to,.vc-slide-down-enter-from,.vc-slide-down-leave-to,.vc-slide-fade-enter-from,.vc-slide-fade-leave-to{opacity:0}.vc-slide-left-enter-from,.vc-slide-right-leave-to,.vc-slide-fade-enter-from.direction-left,.vc-slide-fade-leave-to.direction-left{transform:translate(var(--vc-slide-translate))}.vc-slide-right-enter-from,.vc-slide-left-leave-to,.vc-slide-fade-enter-from.direction-right,.vc-slide-fade-leave-to.direction-right{transform:translate(calc(-1 * var(--vc-slide-translate)))}.vc-slide-up-enter-from,.vc-slide-down-leave-to,.vc-slide-fade-enter-from.direction-top,.vc-slide-fade-leave-to.direction-top{transform:translateY(var(--vc-slide-translate))}.vc-slide-down-enter-from,.vc-slide-up-leave-to,.vc-slide-fade-enter-from.direction-bottom,.vc-slide-fade-leave-to.direction-bottom{transform:translateY(calc(-1 * var(--vc-slide-translate)))}:root{--vc-white: #ffffff;--vc-black: #000000;--vc-gray-50: #f8fafc;--vc-gray-100: #f1f5f9;--vc-gray-200: #e2e8f0;--vc-gray-300: #cbd5e1;--vc-gray-400: #94a3b8;--vc-gray-500: #64748b;--vc-gray-600: #475569;--vc-gray-700: #334155;--vc-gray-800: #1e293b;--vc-gray-900: #0f172a;--vc-font-family: BlinkMacSystemFont, -apple-system, "Segoe UI", "Roboto", "Oxygen", "Ubuntu", "Cantarell", "Fira Sans", "Droid Sans", "Helvetica Neue", "Helvetica", "Arial", sans-serif;--vc-font-normal: 400;--vc-font-medium: 500;--vc-font-semibold: 600;--vc-font-bold: 700;--vc-text-2xs: 10px;--vc-text-xs: 12px;--vc-text-sm: 14px;--vc-text-base: 16px;--vc-text-lg: 18px;--vc-text-xl: 20px;--vc-text-2xl: 24px;--vc-leading-none: 1;--vc-leading-tight: 1.25;--vc-leading-snug: 1.375;--vc-leading-normal: 1.5;--vc-rounded: .25rem;--vc-rounded-md: .375rem;--vc-rounded-lg: .5rem;--vc-rounded-full: 9999px;--vc-shadow: 0 1px 3px 0 rgba(0, 0, 0, .1), 0 1px 2px 0 rgba(0, 0, 0, .06);--vc-shadow-lg: 0 10px 15px -3px rgba(0, 0, 0, .1), 0 4px 6px -2px rgba(0, 0, 0, .05);--vc-shadow-inner: inset 0 2px 4px 0 rgba(0, 0, 0, .06);--vc-slide-translate: 22px;--vc-slide-duration: .15s;--vc-slide-timing: ease;--vc-day-content-transition: all .13s ease-in;--vc-weeknumber-offset-inside: 26px;--vc-weeknumber-offset-outside: 34px}.vc-gray{--vc-accent-50: var(--vc-gray-50);--vc-accent-100: var(--vc-gray-100);--vc-accent-200: var(--vc-gray-200);--vc-accent-300: var(--vc-gray-300);--vc-accent-400: var(--vc-gray-400);--vc-accent-500: var(--vc-gray-500);--vc-accent-600: var(--vc-gray-600);--vc-accent-700: var(--vc-gray-700);--vc-accent-800: var(--vc-gray-800);--vc-accent-900: var(--vc-gray-900)}.vc-red{--vc-accent-50: #fef2f2;--vc-accent-100: #fee2e2;--vc-accent-200: #fecaca;--vc-accent-300: #fca5a5;--vc-accent-400: #f87171;--vc-accent-500: #ef4444;--vc-accent-600: #dc2626;--vc-accent-700: #b91c1c;--vc-accent-800: #991b1b;--vc-accent-900: #7f1d1d}.vc-orange{--vc-accent-50: #fff7ed;--vc-accent-100: #ffedd5;--vc-accent-200: #fed7aa;--vc-accent-300: #fdba74;--vc-accent-400: #fb923c;--vc-accent-500: #f97316;--vc-accent-600: #ea580c;--vc-accent-700: #c2410c;--vc-accent-800: #9a3412;--vc-accent-900: #7c2d12}.vc-yellow{--vc-accent-50: #fefce8;--vc-accent-100: #fef9c3;--vc-accent-200: #fef08a;--vc-accent-300: #fde047;--vc-accent-400: #facc15;--vc-accent-500: #eab308;--vc-accent-600: #ca8a04;--vc-accent-700: #a16207;--vc-accent-800: #854d0e;--vc-accent-900: #713f12}.vc-green{--vc-accent-50: #f0fdf4;--vc-accent-100: #dcfce7;--vc-accent-200: #bbf7d0;--vc-accent-300: #86efac;--vc-accent-400: #4ade80;--vc-accent-500: #22c55e;--vc-accent-600: #16a34a;--vc-accent-700: #15803d;--vc-accent-800: #166534;--vc-accent-900: #14532d}.vc-teal{--vc-accent-50: #f0fdfa;--vc-accent-100: #ccfbf1;--vc-accent-200: #99f6e4;--vc-accent-300: #5eead4;--vc-accent-400: #2dd4bf;--vc-accent-500: #14b8a6;--vc-accent-600: #0d9488;--vc-accent-700: #0f766e;--vc-accent-800: #115e59;--vc-accent-900: #134e4a}.vc-blue{--vc-accent-50: #eff6ff;--vc-accent-100: #dbeafe;--vc-accent-200: #bfdbfe;--vc-accent-300: #93c5fd;--vc-accent-400: #60a5fa;--vc-accent-500: #3b82f6;--vc-accent-600: #2563eb;--vc-accent-700: #1d4ed8;--vc-accent-800: #1e40af;--vc-accent-900: #1e3a8a}.vc-indigo{--vc-accent-50: #eef2ff;--vc-accent-100: #e0e7ff;--vc-accent-200: #c7d2fe;--vc-accent-300: #a5b4fc;--vc-accent-400: #818cf8;--vc-accent-500: #6366f1;--vc-accent-600: #4f46e5;--vc-accent-700: #4338ca;--vc-accent-800: #3730a3;--vc-accent-900: #312e81}.vc-purple{--vc-accent-50: #faf5ff;--vc-accent-100: #f3e8ff;--vc-accent-200: #e9d5ff;--vc-accent-300: #d8b4fe;--vc-accent-400: #c084fc;--vc-accent-500: #a855f7;--vc-accent-600: #9333ea;--vc-accent-700: #7e22ce;--vc-accent-800: #6b21a8;--vc-accent-900: #581c87}.vc-pink{--vc-accent-50: #fdf2f8;--vc-accent-100: #fce7f3;--vc-accent-200: #fbcfe8;--vc-accent-300: #f9a8d4;--vc-accent-400: #f472b6;--vc-accent-500: #ec4899;--vc-accent-600: #db2777;--vc-accent-700: #be185d;--vc-accent-800: #9d174d;--vc-accent-900: #831843}.vc-focus:focus-within{outline:0;box-shadow:var(--vc-focus-ring)}.vc-light{--vc-color: var(--vc-gray-900);--vc-bg: var(--vc-white);--vc-border: var(--vc-gray-300);--vc-hover-bg: hsla(211, 25%, 84%, .3);--vc-focus-ring: 0 0 0 2px rgb(59, 131, 246, .4);--vc-header-arrow-color: var(--vc-gray-500);--vc-header-arrow-hover-bg: var(--vc-gray-200);--vc-header-title-color: var(--vc-gray-900);--vc-weekday-color: var(--vc-gray-500);--vc-weeknumber-color: var(--vc-gray-400);--vc-nav-hover-bg: var(--vc-gray-200);--vc-nav-title-color: var(--vc-gray-900);--vc-nav-item-hover-box-shadow: none;--vc-nav-item-active-color: var(--vc-white);--vc-nav-item-active-bg: var(--vc-accent-500);--vc-nav-item-active-box-shadow: var(--vc-shadow);--vc-nav-item-current-color: var(--vc-accent-600);--vc-day-popover-container-color: var(--vc-white);--vc-day-popover-container-bg: var(--vc-gray-800);--vc-day-popover-container-border: var(--vc-gray-700);--vc-day-popover-header-color: var(--vc-gray-700);--vc-popover-content-color: var(--vc-gray-900);--vc-popover-content-bg: var(--vc-gray-50);--vc-popover-content-border: var(--vc-gray-300);--vc-time-picker-border: var(--vc-gray-300);--vc-time-weekday-color: var(--vc-gray-700);--vc-time-month-color: var(--vc-accent-600);--vc-time-day-color: var(--vc-accent-600);--vc-time-year-color: var(--vc-gray-500);--vc-time-select-group-bg: var(--vc-gray-50);--vc-time-select-group-border: var(--vc-gray-300);--vc-time-select-group-icon-color: var(--vc-accent-500);--vc-select-color: var(--vc-gray-900);--vc-select-bg: var(--vc-gray-100);--vc-select-hover-bg: var(--vc-gray-200);--vc-day-content-hover-bg: var(--vc-hover-bg);--vc-day-content-disabled-color: var(--vc-gray-400)}.vc-light.vc-attr,.vc-light .vc-attr{--vc-content-color: var(--vc-accent-600);--vc-highlight-outline-bg: var(--vc-white);--vc-highlight-outline-border: var(--vc-accent-600);--vc-highlight-outline-content-color: var(--vc-accent-700);--vc-highlight-light-bg: var(--vc-accent-200);--vc-highlight-light-content-color: var(--vc-accent-900);--vc-highlight-solid-bg: var(--vc-accent-600);--vc-highlight-solid-content-color: var(--vc-white);--vc-dot-bg: var(--vc-accent-600);--vc-bar-bg: var(--vc-accent-600)}.vc-dark{--vc-color: var(--vc-white);--vc-bg: var(--vc-gray-900);--vc-border: var(--vc-gray-700);--vc-hover-bg: hsla(216, 15%, 52%, .3);--vc-focus-ring: 0 0 0 2px rgb(59 130 246 / .7);--vc-header-arrow-color: var(--vc-gray-300);--vc-header-arrow-hover-bg: var(--vc-gray-800);--vc-header-title-color: var(--vc-gray-100);--vc-weekday-color: var(--vc-accent-200);--vc-weeknumber-color: var(--vc-gray-500);--vc-nav-hover-bg: var(--vc-gray-700);--vc-nav-title-color: var(--vc-gray-100);--vc-nav-item-hover-box-shadow: none;--vc-nav-item-active-color: var(--vc-white);--vc-nav-item-active-bg: var(--vc-accent-500);--vc-nav-item-active-box-shadow: none;--vc-nav-item-current-color: var(--vc-accent-400);--vc-day-popover-container-color: var(--vc-gray-800);--vc-day-popover-container-bg: var(--vc-white);--vc-day-popover-container-border: var(--vc-gray-100);--vc-day-popover-header-color: var(--vc-gray-300);--vc-popover-content-color: var(--vc-white);--vc-popover-content-bg: var(--vc-gray-800);--vc-popover-content-border: var(--vc-gray-700);--vc-time-picker-border: var(--vc-gray-700);--vc-time-weekday-color: var(--vc-gray-400);--vc-time-month-color: var(--vc-accent-400);--vc-time-day-color: var(--vc-accent-400);--vc-time-year-color: var(--vc-gray-500);--vc-time-select-group-bg: var(--vc-gray-700);--vc-time-select-group-border: var(--vc-gray-500);--vc-time-select-group-icon-color: var(--vc-accent-400);--vc-select-color: var(--vc-gray-200);--vc-select-bg: var(--vc-gray-700);--vc-select-hover-bg: var(--vc-gray-600);--vc-day-content-hover-bg: var(--vc-hover-bg);--vc-day-content-disabled-color: var(--vc-gray-600)}.vc-dark.vc-attr,.vc-dark .vc-attr{--vc-content-color: var(--vc-accent-500);--vc-highlight-outline-bg: var(--vc-gray-900);--vc-highlight-outline-border: var(--vc-accent-300);--vc-highlight-outline-content-color: var(--vc-accent-200);--vc-highlight-light-bg: var(--vc-accent-800);--vc-highlight-light-content-color: var(--vc-accent-100);--vc-highlight-solid-bg: var(--vc-accent-500);--vc-highlight-solid-content-color: var(--vc-white);--vc-dot-bg: var(--vc-accent-500);--vc-bar-bg: var(--vc-accent-500)}.vc-container{position:relative;display:inline-flex;width:-moz-max-content;width:max-content;height:-moz-max-content;height:max-content;font-family:var(--vc-font-family);color:var(--vc-color);background-color:var(--vc-bg);-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;-webkit-tap-highlight-color:transparent}.vc-container,.vc-container *{box-sizing:border-box}.vc-container:focus,.vc-container *:focus{outline:none}.vc-container .vc-container{border:none}.vc-bordered{border:1px solid;border-color:var(--vc-border);border-radius:var(--vc-rounded-lg)}.vc-expanded{min-width:100%}.vc-transparent{background-color:transparent}.vc-date-picker-content{padding:0;background-color:var(--vc-bg)}.vc-date-picker-content .vc-container{border:0}div.vc-day{border-left:1px solid #e4e7e7!important;border-top:1px solid #e4e7e7!important;padding:0!important}div.vc-day.weekday-position-7{border-right:1px solid #e4e7e7!important}div.vc-weeks>div.vc-week:last-child>div.vc-day{border-bottom:1px solid #e4e7e7!important}div.vc-day-content{width:100%!important;border-radius:0!important;margin:0!important}.dp__theme_light{--dp-background-color: #ffffff;--dp-text-color: #212121;--dp-hover-color: #75bce1;--dp-hover-text-color: #ffffff;--dp-hover-icon-color: #ffffff;--dp-primary-color: #0987ca;--dp-primary-text-color: #ffffff;--dp-secondary-color: #212121;--dp-border-color: #ffffff;--dp-range-between-dates-background-color: var(--dp-hover-color, #75bce1);--dp-range-between-dates-text-color: var(--dp-hover-text-color, #ffffff);--dp-range-between-border-color: var(--dp-hover-color, #ffffff)}', zI = (e, t) => {
  ...
  setup(e) {
    const n = `https://www.camperfuchs.de/api/V1/articles/${e.vehicleId}/calendar`, o = `https://www.camperfuchs.de/api/V1/articles/${e.vehicleId}/resolve`, a = be([
      ...
      var I, C, B;
      return `https://www.camperfuchs.de/checkout/${e.vehicleId}/${(I = i.value) == null ? void 0 : I.relevantStationId}?from=${(C = l.value) == null ? void 0 : C.start}&to=${(B = l.value) == null ? void 0 : B.end}`;
    }), d = A(() => {
      var I, C, B;
      return `https://www.camperfuchs.de/checkout/${e.vehicleId}/${(I = i.value) == null ? void 0 : I.relevantStationId}/request?from=${(C = l.value) == null ? void 0 : C.start}&to=${(B = l.value) == null ? void 0 : B.end}`;
    });
    function h(I, C, B, j) {
      let K = uo(I), _ = uo(C);
      K > _ && ([K, _] = [_, K]), s.value.push({
        bar: {
          style: {
            backgroundColor: j
          }
    ...
    function b(I) {
      var j, K, _;
      let C = /* @__PURE__ */ new Set(), B = /* @__PURE__ */ new Set();
      for (let U = 0; U < ((j = I.value) == null ? void 0 : j.pickupAndReturnTimes.length); U++)
        for (let oe in (K = I.value) == null ? void 0 : K.pickupAndReturnTimes[U])
          (_ = I.value) != null && _.pickupAndReturnTimes[U][oe].open || (B.add(U + 1), C.add(U));
      g.value = Array.from(C), s.value.push({
        bar: {
          style: {
    ...
    const D = async () => {
      try {
        ...
        C.bookedDays.forEach((j) => h(j.from, j.to, "Fahrzeug ist nicht verfügbar", "#960303")), C.daysOff.forEach((j) => h(j.from, j.to, "Standort geschlossen", "#d8bd00"));
        const B = await fetch(o);
        i.value = await B.json(), b(i);
      } catch (I) {
        console.error("An error occurred while fetching the data:", I);
      }
    }, y = A(() => {
      var I, C, B;
      return ((I = l.value) == null ? void 0 : I.start) === null || ((C = l.value) == null ? void 0 : C.end) === null || ((B = i.value) == null ? void 0 : B.relevantStationId) === null;
    }), F = A(() => {
      var C, B, j, K, _, U;
      let I = {
        isValid: !1,
      ...
      if (((B = l.value) == null ? void 0 : B.start) !== null && ((j = l.value) == null ? void 0 : j.end) !== null) {
        let oe = (K = l.value) == null ? void 0 : K.start, Q = (_ = l.value) == null ? void 0 : _.end;
        if (c.value = g.value.includes(oe.getDay()) || g.value.includes(Q.getDay()), oe > Q) {
          let ee = oe;
          oe = Q, Q = ee;
        }
        const re = OI(Q, oe);
        (U = i.value) == null || U.seasons.forEach((ee) => {
          const ie = uo(ee.from), he = uo(ee.to);
          oe >= ie && Q <= he && (I.season = ee.type, I.minDays = i.value.minDays[ee.type], I.days = re);
        }), I.isValid = re >= I.minDays, I.days = re;
      }
      return I;
    }), L = A(() => {
      let I = 0;
      return F.value.isValid && (I = F.value.days * i.value.rates[F.value.season]), I;
    }), E = {
      std: "Standard Saison",
      high: "Hauptsaison",
      low: "Nebensaison"
    ...
    return Pr(() => {
      ...
      navigateToBookingUrl: () => {
        F.value.isValid && !c.value && window.open(f.value, "_blank");
      },
      navigateToRequestUrl: () => {
        F.value.isValid && !c.value && window.open(d.value, "_blank");
      },
      columns: 1,
      expanded: !0
    };
  }
}, VI = { class: "flex flex-col items-center gap-4 bg-white p-2" }, KI = /* @__PURE__ */ J("div", { class: "flex flex-col w-full gap-4" }, [
...
}, qI = { class: "font-medium" }, ZI = { class: "flex justify-between gap-4 w-full" }, JI = /* @__PURE__ */ J("span", { class: "font-medium" }, "Ausgewählte Nächte:", -1), XI = { class: "font-normal" }, eE = { class: "flex justify-between gap-4 w-full" }, tE = /* @__PURE__ */ J("span", { class: "font-medium" }, "Mietpreis:", -1), rE = { class: "font-normal" }, nE = { class: "flex justify-between gap-4 w-full" }, oE = /* @__PURE__ */ J("span", { class: "font-medium" }, "Kaution:", -1), aE = { class: "font-normal" }, sE = { class: "text-red-500 text-sm break-words text-center" };
function iE(e, t, r, n, o, a) {
  ...
  return G(), ne("div", VI, [
    ...
    n.isValidRange.isValid && !n.isPickupReturnDaysWrong ? (G(), ne("div", QI, [
      J("span", qI, Le(n.season[n.isValidRange.season]), 1),
      J("span", ZI, [
        JI,
        J("span", XI, Le(n.isValidRange.days), 1)
      ]),
      J("span", eE, [
        tE,
        J("span", rE, Le(n.totalRate) + " €", 1)
      ]),
      J("span", nE, [
        oE,
        J("span", aE, Le((i = n.article) == null ? void 0 : i.deposit) + " €", 1)
      ])
    ])) : Fe("", !0),
    ...
    En(J("span", sE, " An Tagen, an denen die Einrichtung geschlossen ist, können die Fahrzeuge nicht abgeholt oder zurückgebracht werden. ", 512), [
